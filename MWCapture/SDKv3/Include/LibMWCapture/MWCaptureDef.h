...
typedef void (*LPFN_VIDEO_CAPTURE_CALLBACK)(LPBYTE pbFrame, DWORD cbFrame,
					    DWORD cbStride,
...
typedef void (*LPFN_AUDIO_CAPTURE_CALLBACK)(
	MWCAP_AUDIO_CAPTURE_FRAME *pAudioCaptureFrame, void *pvContent);
typedef struct _MWCAP_AUDIO_CAPTURE {
	_MWCAP_AUDIO_CAPTURE() : lpfnAudioCaptureCallback(NULL), pvContext(NULL)
	{
	}
...
typedef void (*LPFN_NOTIFY_CALLBACK)(MWCAP_PTR64 pNotify, DWORD dwEnableBits,
				     void *pvContent);
...
*/
typedef void (*VIDEO_CAPTURE_CALLBACK)(BYTE *pbFrame, int cbFrame,
 ...
 * 		   [MWCreateAudioCapture](@ref MWCreateAudioCapture)\n
*/
typedef void (*AUDIO_CAPTURE_CALLBACK)(const BYTE *pbFrame, int cbFrame,
				       UINT64 u64TimeStamp, void *pParam);
...
*/
typedef void(__stdcall *VIDEO_CAPTURE_STDCALL_CALLBACK)(BYTE *pbFrame,
							int cbFrame,
							UINT64 u64TimeStamp,
							void *pParam);
 ...
 * 		   [MWCreateAudioCaptureWithStdCallBack](@ref MWCreateAudioCaptureWithStdCallBack)\n
*/
typedef void(__stdcall *AUDIO_CAPTURE_STDCALL_CALLBACK)(const BYTE *pbFrame,
							int cbFrame,
							UINT64 u64TimeStamp,
							void *pParam);
...
typedef void (*LPFN_HOT_PLUG_CALLBACK)(MWCAP_USBHOT_PLUG_EVENT event,
				       const char *pszDevicePath, void *pParam);
typedef void (*LPFN_HOT_PLUG_STDCALL_CALLBACK)(MWCAP_USBHOT_PLUG_EVENT event,
