...
enum _MWCAP_HID_EXTENSION {
	...
	// Miscs
	MWCAP_HID_CORE_TEMPERATURE =
		0x58,           // G,	Data: uint8_t, int32_t (in 0.1 deg C)
	...
	MWCAP_HID_AUDIO_VOLUME_MICROPHONE =
		0xB0, // G/S,	Data: uint8_t, MWCAP_AUDIO_VOLUME
	...
	MWCAP_HID_FIRMWARE_STORAGE =
		0xF0,             // G, 	Data: uint8_t, MWCAP_FIRMWARE_STORAGE
...
#define MWCAP_USB_AUDIO_CAP_EMBEDDED_CAPTURE \
	(1 << MWCAP_USB_AUDIO_EMBEDDED_CAPTURE)
#define MWCAP_USB_AUDIO_CAP_EMBEDDED_PLAYBACK \
	(1 << MWCAP_USB_AUDIO_EMBEDDED_PLAYBACK)
...
#define MWCAP_NOTIFY_VOLUME_MICROPHONE \
	(1ULL << (48 + MWCAP_USB_AUDIO_MICROPHONE))
...
#define MWCAP_NOTIFY_VOLUME_EMBEDDED_CAPTURE \
	(1ULL << (48 + MWCAP_USB_AUDIO_EMBEDDED_CAPTURE))
#define MWCAP_NOTIFY_VOLUME_EMBEDDED_PLAYBACK \
	(1ULL << (48 + MWCAP_USB_AUDIO_EMBEDDED_PLAYBACK))
#define MWCAP_NOTIFY_VOLUME_USB_CAPTURE \
	(1ULL << (48 + MWCAP_USB_AUDIO_USB_CAPTURE))
#define MWCAP_NOTIFY_VOLUME_USB_PLAYBACK \
	(1ULL << (48 + MWCAP_USB_AUDIO_USB_PLAYBACK))
