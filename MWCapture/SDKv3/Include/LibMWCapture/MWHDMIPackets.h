...
static const BYTE g_abyDefaultYUV709VICs[] = {0,  1,  4,  5,  16, 19, 20,
					      31, 32, 33, 34, 39, 40, 46,
					      47, 60, 61, 62, 63, 64};
...
static const DWORD g_adwHDMIAudioSampleRate[] = {0,     32000, 44100,  48000,
...
public:
	...
	{
		return abyRegistrationId[0] | (abyRegistrationId[1] << 8) |
		       (abyRegistrationId[2] << 16);
	}
