...
#if INIT_CUDA_GL
inline CUresult CUDAAPI cuInitGL(unsigned int Flags, int cudaVersion,
...
inline CUresult CUDAAPI cuInitD3D9(unsigned int Flags, int cudaVersion,
				   CUDADRIVER &CudaDrvLib)
{
...
inline CUresult CUDAAPI cuInitD3D10(unsigned int Flags, int cudaVersion,
				    CUDADRIVER &CudaDrvLib)
{
	if (cudaVersion >= 2030) {
...
#ifdef INIT_CUDA_D3D11
inline CUresult CUDAAPI cuInitD3D11(unsigned int Flags, int cudaVersion,
				    CUDADRIVER &CudaDrvLib)
{
	if (cudaVersion >= 3000) {
