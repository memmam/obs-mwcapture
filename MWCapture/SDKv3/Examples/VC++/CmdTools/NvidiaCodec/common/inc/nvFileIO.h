...
inline U32 nvSetFilePointer(HANDLE hInputFile, U32 fileOffset,
			    U32 *moveFilePointer, U32 flag)
{
...
inline U32 nvSetFilePointer64(HANDLE hInputFile, U64 fileOffset,
			      U64 *moveFilePointer, U32 flag)
{
#if defined(NV_WINDOWS)
	return SetFilePointer(hInputFile, ((U32 *)&fileOffset)[0],
			      (PLONG) & ((U32 *)&fileOffset)[1], flag);
#elif defined __linux || defined __APPLE__ || defined __MACOSX
	return fseek((FILE *)hInputFile, (long int)fileOffset, flag);
#endif
}

inline bool nvReadFile(HANDLE hInputFile, void *buf, U32 bytes_to_read,
		       U32 *bytes_read, void *operlapped)
{
#if defined(NV_WINDOWS)
...
inline void nvGetFileSize(HANDLE hInputFile, DWORD *pFilesize)
{
	...
	if (hInputFile != INVALID_HANDLE_VALUE) {
		file_size.LowPart =
			GetFileSize(hInputFile, (LPDWORD)&file_size.HighPart);
		printf("[ Input Filesize] : %ld bytes\n",
		       ((LONGLONG)file_size.HighPart << 32) +
			       (LONGLONG)file_size.LowPart);
...
#if defined(NV_WINDOWS)
	hInput = CreateFileA(input_file, GENERIC_READ, FILE_SHARE_READ, NULL,
...
#if defined(NV_WINDOWS)
	hOutput = CreateFileA(output_file, GENERIC_WRITE, FILE_SHARE_WRITE,
