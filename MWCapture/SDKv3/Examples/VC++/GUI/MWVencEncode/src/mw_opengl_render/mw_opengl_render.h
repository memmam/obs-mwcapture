...
protected:
	...
	mw_render_stat_t render_rgba(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_ARGB
	mw_render_stat_t open_argb(bool t_b_hdr);
	mw_render_stat_t render_argb(void *data, mw_render_ctrl_t *rctrl,
				     bool black);
	...
	mw_render_stat_t render_bgra(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_ABGR
	mw_render_stat_t open_abgr(bool t_b_hdr);
	mw_render_stat_t render_abgr(void *data, mw_render_ctrl_t *rctrl,
				     bool black);
	...
	mw_render_stat_t render_yuy2(void *data, mw_render_ctrl_t *rctrl,
				     bool black);
	...
	mw_render_stat_t render_i420(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_IYUV
	//MW_RENDER_FOURCC_NV12
	mw_render_stat_t open_nv12(bool t_b_hdr);
	mw_render_stat_t render_nv12(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_YV12
	mw_render_stat_t open_yv12(bool t_b_hdr);
	mw_render_stat_t render_yv12(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_NV21
	mw_render_stat_t open_nv21(bool t_b_hdr);
	mw_render_stat_t render_nv21(void *data, mw_render_ctrl_t *rctrl,
				     bool black);

	//MW_RENDER_FOURCC_P010
	mw_render_stat_t open_p010(bool t_b_hdr);
	mw_render_stat_t render_p010(void *data, mw_render_ctrl_t *rctrl,
				     bool black);
	mw_render_stat_t render_p010_hdr(void *data, mw_render_ctrl_ex_t *rctrl,
					 bool black);
	...
	mw_render_stat_t init_render_sdr(const char *t_cs_ver,
					 const char *t_cs_frag, void *t_p_ver,
					 void *t_p_tex);

	mw_render_stat_t init_render_hdr(const char *t_cs_ver,
					 const char *t_cs_frag, void *t_p_ver,
					 void *t_p_tex);

	mw_render_stat_t init_pbo(uint32_t t_u32_size);

	mw_render_stat_t gen_tex(int32_t t_i32_tex_num);

	mw_render_stat_t render_uv_rgb(int32_t t_i32_tex_num,
				       mw_render_ctrl_t *t_p_ctrl,
				       bool t_b_black);

	mw_render_stat_t render_uv_yuv(int32_t t_i32_tex_num,
				       mw_render_ctrl_t *t_p_ctrl,
				       bool t_b_black);

	mw_render_stat_t render_uv_yuv_pbo(int32_t t_i32_tex_num,
					   mw_render_ctrl_t *t_p_ctrl,
					   bool t_b_black, void *t_p_data,
					   uint32_t t_u32_size);

	mw_render_stat_t render_uv_yuv_hdr(int32_t t_i32_tex_num,
