...
bool MWDXRender::create_render_with_fourcc(DWORD t_dw_fourcc, bool t_b_reverse,
					   mw_color_space_e t_color_format,
					   mw_color_space_level_e input_range,
					   mw_color_space_level_e output_range)
{
	HRESULT t_hr = S_FALSE;
	...
	if (t_dw_fourcc == MWFOURCC_GREY || t_dw_fourcc == MWFOURCC_Y800 ||
	    t_dw_fourcc == MWFOURCC_Y8 || t_dw_fourcc == MWFOURCC_Y16 ||
	    t_dw_fourcc == MWFOURCC_RGB16 || t_dw_fourcc == MWFOURCC_BGR16 ||
	    t_dw_fourcc == MWFOURCC_YUY2 || t_dw_fourcc == MWFOURCC_YUYV ||
	    t_dw_fourcc == MWFOURCC_UYVY || t_dw_fourcc == MWFOURCC_YVYU ||
	    t_dw_fourcc == MWFOURCC_VYUY || t_dw_fourcc == MWFOURCC_BGR24 ||
	    t_dw_fourcc == MWFOURCC_RGB24 || t_dw_fourcc == MWFOURCC_NV12 ||
	    t_dw_fourcc == MWFOURCC_NV21 || t_dw_fourcc == MWFOURCC_NV16 ||
	    t_dw_fourcc == MWFOURCC_NV61 || t_dw_fourcc == MWFOURCC_I422 ||
	    t_dw_fourcc == MWFOURCC_YV16 || t_dw_fourcc == MWFOURCC_I420 ||
	    t_dw_fourcc == MWFOURCC_IYUV || t_dw_fourcc == MWFOURCC_YV12 ||
	    t_dw_fourcc == MWFOURCC_P010 || t_dw_fourcc == MWFOURCC_P210 ||
	    t_dw_fourcc == MWFOURCC_IYU2 || t_dw_fourcc == MWFOURCC_V308 ||
	    t_dw_fourcc == MWFOURCC_AYUV || t_dw_fourcc == MWFOURCC_UYVA ||
	    t_dw_fourcc == MWFOURCC_V408 || t_dw_fourcc == MWFOURCC_VYUA ||
	...
	if (t_dw_fourcc == MWFOURCC_BGR24 || t_dw_fourcc == MWFOURCC_RGB24 ||
	    t_dw_fourcc == MWFOURCC_IYU2 || t_dw_fourcc == MWFOURCC_V308) {
	...
	if (t_dw_fourcc == MWFOURCC_NV12 || t_dw_fourcc == MWFOURCC_NV21) {
		// Create the render target texture
		...
		if (FAILED(t_hr))
			return false;
	} else if (t_dw_fourcc == MWFOURCC_NV16 ||
		...
		m_p_texture_2d_3 = NULL;
		t_hr = m_p_device->CreateTexture2D(&desc3, NULL,
						   &m_p_texture_2d_3);
		if (FAILED(t_hr))
			return false;
		...
		srDesc3.Texture2D.MipLevels =
			D3DX11_DEFAULT; //1; //D3DX11_DEFAULT;

		t_hr = m_p_device->CreateShaderResourceView(
			m_p_texture_2d_3, &srDesc3,
			&m_p_shader_resource_view_3);
		if (FAILED(t_hr))
			return false;
	...
	yuvlevels t_lev_tv = {16.0 / 255.0, 235.0 / 255.0, 240.0 / 255.0,
			      128.0 / 255.0};
	...
	double cmul =
		(rgblev.max - rgblev.min) / (yuvlev.cmax - yuvlev.cmid) / 2.0;
	...
	for (int i = 0; i < 3; i++) {
		...
		csp_const[i] =
			rgblev.min - csp_coeff[i][0] * yuvlev.ymin -
	...
	if (t_dw_fourcc == MWFOURCC_GREY || t_dw_fourcc == MWFOURCC_Y800 ||
	    ...
	    t_dw_fourcc == MWFOURCC_RGB16 || t_dw_fourcc == MWFOURCC_BGR16 ||
	    t_dw_fourcc == MWFOURCC_YUY2 || t_dw_fourcc == MWFOURCC_YUYV ||
	    t_dw_fourcc == MWFOURCC_BGR24 || t_dw_fourcc == MWFOURCC_RGB24 ||
	    t_dw_fourcc == MWFOURCC_UYVY || t_dw_fourcc == MWFOURCC_YVYU ||
	    t_dw_fourcc == MWFOURCC_VYUY || t_dw_fourcc == MWFOURCC_NV12 ||
	    t_dw_fourcc == MWFOURCC_NV21 || t_dw_fourcc == MWFOURCC_NV16 ||
	    t_dw_fourcc == MWFOURCC_NV61 || t_dw_fourcc == MWFOURCC_I422 ||
	    t_dw_fourcc == MWFOURCC_YV16 || t_dw_fourcc == MWFOURCC_I420 ||
	    t_dw_fourcc == MWFOURCC_IYUV || t_dw_fourcc == MWFOURCC_YV12 ||
	...
	if (t_dw_fourcc == MWFOURCC_NV12 || t_dw_fourcc == MWFOURCC_NV21 ||
	    t_dw_fourcc == MWFOURCC_NV16 || t_dw_fourcc == MWFOURCC_NV61 ||
	    t_dw_fourcc == MWFOURCC_P010 || t_dw_fourcc == MWFOURCC_P210) {
		...
		m_p_device_context->PSSetShaderResources(
			1, 1, &m_p_shader_resource_view_2);
		m_p_device_context->PSSetShaderResources(
			2, 1, &m_p_shader_resource_view_3);
	} else {
		m_p_device_context->PSSetShaderResources(
			0, 1, &m_p_shader_resource_view);
	}
...
bool MWDXRender::initialize(int t_n_width, int t_n_height, DWORD dwFourcc,
			    ...
			    mw_color_space_e t_color_format,
			    mw_color_space_level_e t_input_range,
			    mw_color_space_level_e t_output_range)
{
	bool t_b_ret = false;
	m_b_set = false;
	HRESULT t_hr = S_FALSE;
	...
	create_render_with_fourcc(dwFourcc, t_b_reverse, t_color_format,
				  t_input_range, t_output_range);
...
bool MWDXRender::paint(unsigned char *data)
{
	...
	if (m_dw_fourcc == MWFOURCC_NV12 || m_dw_fourcc == MWFOURCC_NV21 ||
	    m_dw_fourcc == MWFOURCC_NV16 || m_dw_fourcc == MWFOURCC_NV61) {
		m_p_device_context->UpdateSubresource(m_p_texture_2d, 0, NULL,
						      t_p_data, m_n_width, 0);
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d_2, 0, NULL,
			t_p_data + m_n_width * m_n_height, m_n_width, 0);
		...
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d_2, 0, NULL,
			t_p_data + m_n_width * m_n_height, m_n_width,
			m_n_height / 2);
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d_3, 0, NULL,
			t_p_data + m_n_width * m_n_height +
				m_n_width * m_n_height / 2,
			m_n_width, 0);
		...
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d_3, 0, NULL,
			t_p_data + m_n_width * m_n_height +
				m_n_width * m_n_height / 4,
			m_n_width, 0);
	} else if (m_dw_fourcc == MWFOURCC_P010 ||
		   m_dw_fourcc == MWFOURCC_P210) {
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d, 0, NULL, t_p_data, m_n_width * 2,
			m_n_width * 2 * m_n_height);
		m_p_device_context->UpdateSubresource(
			m_p_texture_2d_2, 0, NULL,
			t_p_data + m_n_width * m_n_height * 2, m_n_width * 2,
			0);
	} else {
		m_p_device_context->UpdateSubresource(m_p_texture_2d, 0, NULL,
						      t_p_data, m_n_stride, 0);
	}
