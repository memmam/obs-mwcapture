...
HRESULT MWRender::compile_shader_from_file(WCHAR *t_sz_filepath,
...
HRESULT MWRender::compile_shader_from_cs(unsigned char *t_p_data,
					 int t_n_data_len,
					 LPCSTR t_sz_entrypoint,
					 LPCSTR t_sz_shader_model,
					 ID3DBlob **t_pp_blob_out)
...
bool MWRender::initialize(int t_n_width, int t_n_height, DWORD dwFourcc,
			  HWND t_hwnd)
{
	bool t_b_ret = false;
	m_b_set = false;
