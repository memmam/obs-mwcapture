...
DEFINE_GUID(IID_DecoderSet, 0x19434c39, 0xd9ba, 0x47ca, 0x84, 0xe0, 0xbc, 0x9d,
	    0x2a, 0xbd, 0x9a, 0x1e);
...
__interface IIDecoderSet : public IUnknown
{
	...
	STDMETHOD(GetBacColor)
	(bool *t_bSet, int *r, int *g, int *b, int *a) = 0;
	STDMETHOD(SetBacColor)(bool t_bSet, int r, int g, int b, int a) = 0;

	STDMETHOD(GetFtcColor)
	(bool *t_bSet, int *r, int *g, int *b, int *a) = 0;
