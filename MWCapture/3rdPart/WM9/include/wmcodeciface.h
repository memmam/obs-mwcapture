...
//
//=========================================================================
EXTERN_GUID(IID_IWMVideoDecoderHurryup, 0x352bb3bd, 0x2d4d, 0x4323, 0x9e, 0x71,
	    0xdc, 0xdc, 0xfb, 0xd5, 0x3c, 0xa6);
EXTERN_GUID(IID_IWMCodecStrings, 0xA7B2504B, 0xE58A, 0x47fb, 0x95, 0x8B, 0xCA,
	    0xC7, 0x16, 0x5A, 0x05, 0x7D);
EXTERN_GUID(IID_IWMCodecProps, 0x2573e11a, 0xf01a, 0x4fdd, 0xa9, 0x8d, 0x63,
	    0xb8, 0xe0, 0xbA, 0x95, 0x89);
EXTERN_GUID(IID_IWMCodecLeakyBucket, 0xA81BA647, 0x6227, 0x43b7, 0xB2, 0x31,
	    0xC7, 0xB1, 0x51, 0x35, 0xDD, 0x7D);
EXTERN_GUID(IID_IWMCodecMetaData, 0xd051ed9f, 0xbc5c, 0x4e83, 0xb1, 0x4e, 0x84,
	    0x28, 0x48, 0x5c, 0x28, 0x6a);
EXTERN_GUID(IID_IWMCodecOutputTimestamp, 0xB72ADF95, 0x7ADC, 0x4a72, 0xBC, 0x05,
	    0x57, 0x7D, 0x8E, 0xA6, 0xBF, 0x68);
EXTERN_GUID(IID_IWMCodecPrivateData, 0x73f0be8e, 0x57f7, 0x4f01, 0xaa, 0x66,
	    0x9f, 0x57, 0x34, 0xc, 0xfe, 0xe);
typedef
...
IWMVideoDecoderHurryup_SetHurryup_Proxy(IWMVideoDecoderHurryup *This,
					/* [in] */ LONG lHurryup);
...
HRESULT STDMETHODCALLTYPE
IWMVideoDecoderHurryup_GetHurryup_Proxy(IWMVideoDecoderHurryup *This,
					/* [out] */ LONG *plHurryup);
...
HRESULT STDMETHODCALLTYPE
IWMCodecStrings_GetName_Proxy(IWMCodecStrings *This,
			      /* [in] */ DMO_MEDIA_TYPE *pmt,
			      /* [in] */ ULONG cchLength,
			      /* [out] */ WCHAR *szName,
			      /* [out] */ ULONG *pcchLength);
...
HRESULT STDMETHODCALLTYPE
IWMCodecStrings_GetDescription_Proxy(IWMCodecStrings *This,
				     /* [in] */ DMO_MEDIA_TYPE *pmt,
				     /* [in] */ ULONG cchLength,
				     /* [out] */ WCHAR *szDescription,
				     /* [out] */ ULONG *pcchLength);
...
#define IWMCodecProps_GetFormatProp(This, pmt, pszName, pType, pValue,   \
				    pdwSize)                             \
	(This)->lpVtbl->GetFormatProp(This, pmt, pszName, pType, pValue, \
				      pdwSize)
...
HRESULT STDMETHODCALLTYPE
IWMCodecProps_GetFormatProp_Proxy(IWMCodecProps *This,
				  /* [in] */ DMO_MEDIA_TYPE *pmt,
				  /* [in] */ LPCWSTR pszName,
				  /* [out] */ WMT_PROP_DATATYPE *pType,
				  /* [out] */ BYTE *pValue,
...
HRESULT STDMETHODCALLTYPE
IWMCodecProps_GetCodecProp_Proxy(IWMCodecProps *This,
				 /* [in] */ DWORD dwFormat,
				 /* [in] */ LPCWSTR pszName,
				 /* [out] */ WMT_PROP_DATATYPE *pType,
				 /* [out] */ BYTE *pValue,
...
HRESULT STDMETHODCALLTYPE
IWMCodecLeakyBucket_SetBufferSizeBits_Proxy(IWMCodecLeakyBucket *This,
					    /* [in] */ ULONG ulBufferSize);
...
HRESULT STDMETHODCALLTYPE
IWMCodecLeakyBucket_GetBufferSizeBits_Proxy(IWMCodecLeakyBucket *This,
					    /* [out] */ ULONG *pulBufferSize);
...
typedef struct IWMCodecMetaDataVtbl {
	...
	ULONG(STDMETHODCALLTYPE *AddRef)(IWMCodecMetaData *This);
...
#define IWMCodecMetaData_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IWMCodecMetaData_Release(This) (This)->lpVtbl->Release(This)
...
#define IWMCodecMetaData_GetValueAndName(This, ulValueIndex, pbData, cbData, \
					 pcbData, szName, cchName, pcchName) \
	(This)->lpVtbl->GetValueAndName(This, ulValueIndex, pbData, cbData,  \
					pcbData, szName, cchName, pcchName)
...
HRESULT STDMETHODCALLTYPE
IWMCodecMetaData_GetNumberOfValues_Proxy(IWMCodecMetaData *This,
					 /* [out] */ ULONG *pulNumValues);
...
HRESULT STDMETHODCALLTYPE
IWMCodecMetaData_GetBufferSizes_Proxy(IWMCodecMetaData *This,
				      /* [in] */ ULONG ulValueIndex,
				      /* [out] */ ULONG *pcbData,
				      /* [out] */ ULONG *pcchName);
...
HRESULT STDMETHODCALLTYPE
IWMCodecMetaData_GetValueAndName_Proxy(IWMCodecMetaData *This,
				       /* [in] */ ULONG ulValueIndex,
				       /* [out] */ BYTE *pbData,
				       /* [in] */ ULONG cbData,
				       /* [out] */ ULONG *pcbData,
...
HRESULT STDMETHODCALLTYPE
IWMCodecPrivateData_SetPartialOutputType_Proxy(IWMCodecPrivateData *This,
					       /* [in] */ DMO_MEDIA_TYPE *pmt);
...
HRESULT STDMETHODCALLTYPE
IWMCodecPrivateData_GetPrivateData_Proxy(IWMCodecPrivateData *This,
					 /* [out] */ BYTE *pbData,
					 /* [out][in] */ ULONG *pcbData);
