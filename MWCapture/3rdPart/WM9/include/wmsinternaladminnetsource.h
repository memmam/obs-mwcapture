...
typedef /* [uuid][public] */ DECLSPEC_UUID(
	"068A6457-4099-4c72-9AA9-9105C1C03177") enum NETSOURCE_URLCREDPOLICY_SETTINGS {
...
#define IWMSInternalAdminNetSource_Initialize(This, pSharedNamespace,      \
					      pNamespaceNode,              \
					      pNetSourceCreator,           \
					      fEmbeddedInServer)           \
...
#define IWMSInternalAdminNetSource_SetCredentials(                         \
	...
	(This)->lpVtbl->SetCredentials(This, bstrRealm, bstrName,          \
				       bstrPassword, fPersist, fConfirmedGood)

#define IWMSInternalAdminNetSource_GetCredentials(                  \
	This, bstrRealm, pbstrName, pbstrPassword, pfConfirmedGood) \
	(This)->lpVtbl->GetCredentials(This, bstrRealm, pbstrName,  \
				       pbstrPassword, pfConfirmedGood)
...
IWMSInternalAdminNetSource_IsUsingIE_Proxy(IWMSInternalAdminNetSource *This,
					   /* [in] */ DWORD dwProxyContext,
					   /* [out] */ BOOL *pfIsUsingIE);
...
#define IWMSInternalAdminNetSource2_SetCredentialsEx(This, bstrRealm, bstrUrl, \
						     fProxy, bstrName,         \
						     bstrPassword, fPersist,   \
						     fConfirmedGood)           \
	(This)->lpVtbl->SetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,     \
					 bstrName, bstrPassword, fPersist,     \
					 fConfirmedGood)

#define IWMSInternalAdminNetSource2_GetCredentialsEx(This, bstrRealm, bstrUrl, \
						     fProxy, pdwUrlPolicy,     \
						     pbstrName, pbstrPassword, \
						     pfConfirmedGood)          \
	(This)->lpVtbl->GetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,     \
					 pdwUrlPolicy, pbstrName,              \
					 pbstrPassword, pfConfirmedGood)
...
#define IWMSInternalAdminNetSource2_FindProxyForURLEx(                    \
	This, bstrProtocol, bstrHost, bstrUrl, pfProxyEnabled,            \
	pbstrProxyServer, pdwProxyPort, pdwProxyContext)                  \
	(This)->lpVtbl->FindProxyForURLEx(This, bstrProtocol, bstrHost,   \
					  bstrUrl, pfProxyEnabled,        \
					  pbstrProxyServer, pdwProxyPort, \
					  pdwProxyContext)
...
#define IWMSInternalAdminNetSource3_SetCredentialsEx(This, bstrRealm, bstrUrl, \
						     fProxy, bstrName,         \
						     bstrPassword, fPersist,   \
						     fConfirmedGood)           \
	(This)->lpVtbl->SetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,     \
...
#define IWMSInternalAdminNetSource3_GetCredentialsEx(This, bstrRealm, bstrUrl, \
						     fProxy, pdwUrlPolicy,     \
						     pbstrName, pbstrPassword, \
						     pfConfirmedGood)          \
	(This)->lpVtbl->GetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,     \
...
#define IWMSInternalAdminNetSource3_FindProxyForURLEx2(                    \
	This, bstrProtocol, bstrHost, bstrUrl, pfProxyEnabled,             \
	pbstrProxyServer, pdwProxyPort, pqwProxyContext)                   \
	(This)->lpVtbl->FindProxyForURLEx2(This, bstrProtocol, bstrHost,   \
					   bstrUrl, pfProxyEnabled,        \
					   pbstrProxyServer, pdwProxyPort, \
					   pqwProxyContext)
...
#define IWMSInternalAdminNetSource3_SetCredentialsEx2(                      \
	...
	(This)->lpVtbl->SetCredentialsEx2(This, bstrRealm, bstrUrl, fProxy, \
					  bstrName, bstrPassword, fPersist, \
					  fConfirmedGood,                   \
...
#define IWMSInternalAdminNetSource3_GetCredentialsEx2(                      \
	...
	(This)->lpVtbl->GetCredentialsEx2(This, bstrRealm, bstrUrl, fProxy, \
					  fClearTextAuthentication,         \
					  pdwUrlPolicy, pbstrName,          \
					  pbstrPassword, pfConfirmedGood)
...
HRESULT STDMETHODCALLTYPE
IWMSInternalAdminNetSource3_RegisterProxyFailure2_Proxy(
	IWMSInternalAdminNetSource3 *This,
	/* [in] */ HRESULT hrParam,
	/* [in] */ QWORD qwProxyContext);
...
HRESULT STDMETHODCALLTYPE
IWMSInternalAdminNetSource3_ShutdownProxyContext2_Proxy(
	IWMSInternalAdminNetSource3 *This,
	/* [in] */ QWORD qwProxyContext);
...
HRESULT STDMETHODCALLTYPE
IWMSInternalAdminNetSource3_IsUsingIE2_Proxy(IWMSInternalAdminNetSource3 *This,
					     /* [in] */ QWORD qwProxyContext,
					     /* [out] */ BOOL *pfIsUsingIE);
