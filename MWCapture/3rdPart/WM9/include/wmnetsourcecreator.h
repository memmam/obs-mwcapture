...
#define INSNetSourceCreator_CreateNetSource(This, pszStreamName, pMonitor,    \
					    pData, pUserContext, pCallback,   \
					    qwContext)                        \
...
INSNetSourceCreator_Initialize_Proxy(INSNetSourceCreator *This);
...
HRESULT STDMETHODCALLTYPE
INSNetSourceCreator_CreateNetSource_Proxy(INSNetSourceCreator *This,
					  /* [in] */ LPCWSTR pszStreamName,
					  /* [in] */ IUnknown *pMonitor,
					  /* [in] */ BYTE *pData,
					  /* [in] */ IUnknown *pUserContext,
...
HRESULT STDMETHODCALLTYPE
INSNetSourceCreator_Shutdown_Proxy(INSNetSourceCreator *This);
