...
struct JNINativeInterface_ {
	...
	jboolean(JNICALL *IsAssignableFrom)(JNIEnv *env, jclass sub,
					    jclass sup);
	...
	jboolean(JNICALL *IsSameObject)(JNIEnv *env, jobject obj1,
					jobject obj2);
	...
	jstring(JNICALL *NewString)(JNIEnv *env, const jchar *unicode,
				    jsize len);
...
struct JNIEnv_ {
	...
	jboolean CallBooleanMethod(jobject obj, jmethodID methodID, ...)
	{
		...
		jboolean result;
		va_start(args, methodID);
		result = functions->CallBooleanMethodV(this, obj, methodID,
						       args);
		va_end(args);
		return result;
	}
