...
typedef struct IMediaFilterVtbl {
	...
	(IMediaFilter *This, REFERENCE_TIME tStart);
...
typedef struct IBaseFilterVtbl {
	...
	HRESULT(STDMETHODCALLTYPE *Run)
	(IBaseFilter *This, REFERENCE_TIME tStart);
...
#define IReferenceClock_AdvisePeriodic(This, startTime, periodTime, \
	...
	(This)->lpVtbl->AdvisePeriodic(This, startTime, periodTime, \
				       hSemaphore, pdwAdviseCookie)
...
typedef struct IMediaSampleVtbl {
	...
	(IMediaSample *This, BOOL bIsPreroll);
...
typedef struct IMediaSample2Vtbl {
	...
	HRESULT(STDMETHODCALLTYPE *SetPreroll)
	(IMediaSample2 *This, BOOL bIsPreroll);
...
#define IMemInputPin_ReceiveMultiple(This, pSamples, nSamples,    \
				     nSamplesProcessed)           \
	(This)->lpVtbl->ReceiveMultiple(This, pSamples, nSamples, \
					nSamplesProcessed)
...
#define IMediaSeeking_ConvertTimeFormat(This, pTarget, pTargetFormat, Source, \
					pSourceFormat)                        \
	(This)->lpVtbl->ConvertTimeFormat(This, pTarget, pTargetFormat,       \
...
#define IFilterMapper_RegisterPin(This, Filter, Name, bRendered, bOutput,   \
				  ...
				  ConnectsToPin)                            \
	(This)->lpVtbl->RegisterPin(This, Filter, Name, bRendered, bOutput, \
				    bZero, bMany, ConnectsToFilter,         \
				    ConnectsToPin)

#define IFilterMapper_RegisterPinType(This, clsFilter, strName, clsMajorType, \
				      clsSubType)                             \
	(This)->lpVtbl->RegisterPinType(This, clsFilter, strName,             \
					clsMajorType, clsSubType)
...
#define IFilterMapper_EnumMatchingFilters(This, ppEnum, dwMerit, bInputNeeded, \
	...
	(This)->lpVtbl->EnumMatchingFilters(This, ppEnum, dwMerit,             \
					    bInputNeeded, clsInMaj, clsInSub,  \
					    bRender, bOututNeeded, clsOutMaj,  \
					    clsOutSub)
...
#define IFilterMapper2_UnregisterFilter(This, pclsidCategory, szInstance,  \
					Filter)                            \
	(This)->lpVtbl->UnregisterFilter(This, pclsidCategory, szInstance, \
					 Filter)
...
#define IFilterMapper2_EnumMatchingFilters(                                  \
	This, ppEnum, dwFlags, bExactMatch, dwMerit, bInputNeeded,           \
	cInputTypes, pInputTypes, pMedIn, pPinCategoryIn, bRender,           \
	bOutputNeeded, cOutputTypes, pOutputTypes, pMedOut, pPinCategoryOut) \
	(This)->lpVtbl->EnumMatchingFilters(                                 \
		This, ppEnum, dwFlags, bExactMatch, dwMerit, bInputNeeded,   \
		cInputTypes, pInputTypes, pMedIn, pPinCategoryIn, bRender,   \
		bOutputNeeded, cOutputTypes, pOutputTypes, pMedOut,          \
		pPinCategoryOut)
...
#define IOverlayNotify_OnClipChange(This, pSourceRect, pDestinationRect,  \
				    pRgnData)                             \
	(This)->lpVtbl->OnClipChange(This, pSourceRect, pDestinationRect, \
				     pRgnData)
...
#define IOverlay_GetClipList(This, pSourceRect, pDestinationRect, ppRgnData) \
	(This)->lpVtbl->GetClipList(This, pSourceRect, pDestinationRect,     \
				    ppRgnData)
...
#define ICaptureGraphBuilder_CopyCaptureFile(This, lpwstrOld, lpwstrNew, \
	...
	(This)->lpVtbl->CopyCaptureFile(This, lpwstrOld, lpwstrNew,      \
					fAllowEscAbort, pCallback)
...
#define ICaptureGraphBuilder2_RenderStream(This, pCategory, pType, pSource, \
					   pfCompressor, pfRenderer)        \
	(This)->lpVtbl->RenderStream(This, pCategory, pType, pSource,       \
				     pfCompressor, pfRenderer)

#define ICaptureGraphBuilder2_ControlStream(This, pCategory, pType, pFilter,   \
					    pstart, pstop, wStartCookie,       \
					    wStopCookie)                       \
...
#define IResourceManager_RegisterGroup(This, pName, cResource, palTokens, \
				       plToken)                           \
	(This)->lpVtbl->RegisterGroup(This, pName, cResource, palTokens,  \
				      plToken)
...
#define IAMVideoCompression_GetInfo(This, pszVersion, pcbVersion,             \
				    pszDescription, pcbDescription,           \
...
#define IAMVideoControl_GetMaxAvailableFrameRate(              \
	...
	(This)->lpVtbl->GetMaxAvailableFrameRate(              \
		This, pPin, iIndex, Dimensions, MaxAvailableFrameRate)

#define IAMVideoControl_GetFrameRateList(This, pPin, iIndex, Dimensions, \
					 ListSize, FrameRates)           \
	(This)->lpVtbl->GetFrameRateList(This, pPin, iIndex, Dimensions, \
					 ListSize, FrameRates)
...
#define IKsPropertySet_QuerySupported(This, guidPropSet, dwPropID,  \
				      pTypeSupport)                 \
	(This)->lpVtbl->QuerySupported(This, guidPropSet, dwPropID, \
				       pTypeSupport)
...
#define IAMExtTransport_GetTransportBasicParameters(This, Param, pValue, \
						    ppszData)            \
	(This)->lpVtbl->GetTransportBasicParameters(This, Param, pValue, \
						    ppszData)
...
#define ICodecAPI_SetAllSettingsWithNotify(This, __MIDL_0018, ChangedParam, \
					   ChangedParamCount)               \
	(This)->lpVtbl->SetAllSettingsWithNotify(                           \
		This, __MIDL_0018, ChangedParam, ChangedParamCount)
...
HRESULT STDMETHODCALLTYPE IEncoderAPI_GetValue_Proxy(IEncoderAPI *This,
						     /* [in] */ const GUID *Api,
						     /* [out] */ VARIANT *Value);
...
#define IDvdInfo_GetCurrentAngle(This, pulAnglesAvailable, pulCurrentAngle) \
	(This)->lpVtbl->GetCurrentAngle(This, pulAnglesAvailable,           \
					pulCurrentAngle)

#define IDvdInfo_GetCurrentAudio(This, pulStreamsAvailable, pulCurrentStream) \
	(This)->lpVtbl->GetCurrentAudio(This, pulStreamsAvailable,            \
					pulCurrentStream)
...
#define IDvdInfo_GetDVDTextInfo(This, pTextManager, ulBufSize, pulActualSize) \
	(This)->lpVtbl->GetDVDTextInfo(This, pTextManager, ulBufSize,         \
				       pulActualSize)
...
#define IDvdControl2_PlayChapterInTitle(This, ulTitle, ulChapter, dwFlags,    \
					ppCmd)                                \
	(This)->lpVtbl->PlayChapterInTitle(This, ulTitle, ulChapter, dwFlags, \
					   ppCmd)

#define IDvdControl2_PlayAtTimeInTitle(This, ulTitle, pStartTime, dwFlags,    \
				       ppCmd)                                 \
	(This)->lpVtbl->PlayAtTimeInTitle(This, ulTitle, pStartTime, dwFlags, \
					  ppCmd)
...
#define IDvdControl2_SelectSubpictureStream(This, ulSubPicture, dwFlags,    \
					    ppCmd)                          \
	(This)->lpVtbl->SelectSubpictureStream(This, ulSubPicture, dwFlags, \
					       ppCmd)
...
#define IDvdControl2_SelectDefaultAudioLanguage(This, Language,    \
						audioExtension)    \
	(This)->lpVtbl->SelectDefaultAudioLanguage(This, Language, \
						   audioExtension)
...
#define IDvdInfo2_GetDVDVolumeInfo(This, pulNumOfVolumes, pulVolume, pSide, \
				   pulNumOfTitles)                          \
	(This)->lpVtbl->GetDVDVolumeInfo(This, pulNumOfVolumes, pulVolume,  \
					 pSide, pulNumOfTitles)
...
#define IDvdInfo2_GetDVDTextLanguageInfo(This, ulLangIndex, pulNumOfStrings, \
	...
	(This)->lpVtbl->GetDVDTextLanguageInfo(                              \
...
#define IDvdInfo2_GetDVDTextStringAsNative(This, ulLangIndex, ulStringIndex, \
					   ...
					   pulActualSize, pType)             \
	(This)->lpVtbl->GetDVDTextStringAsNative(This, ulLangIndex,          \
						 ulStringIndex, pbBuffer,    \
						 ulMaxBufferSize,            \
						 pulActualSize, pType)
...
#define IDvdInfo2_GetDVDTextStringAsUnicode(This, ulLangIndex, ulStringIndex, \
					    ...
					    pulActualSize, pType)             \
	(This)->lpVtbl->GetDVDTextStringAsUnicode(This, ulLangIndex,          \
						  ulStringIndex, pchwBuffer,  \
						  ulMaxBufferSize,            \
						  pulActualSize, pType)
...
#define IDvdInfo2_GetDVDDirectory(This, pszwPath, ulMaxSize, pulActualSize) \
	(This)->lpVtbl->GetDVDDirectory(This, pszwPath, ulMaxSize,          \
					pulActualSize)
...
#define IDvdInfo2_GetDefaultAudioLanguage(This, pLanguage, pAudioExtension) \
	(This)->lpVtbl->GetDefaultAudioLanguage(This, pLanguage,            \
						pAudioExtension)
...
#define IDvdGraphBuilder_RenderDvdVideoVolume(This, lpcwszPathName, dwFlags, \
					      pStatus)                       \
	(This)->lpVtbl->RenderDvdVideoVolume(This, lpcwszPathName, dwFlags,  \
					     pStatus)
...
#define IDDrawExclModeVideo_GetNativeVideoProps(This, pdwVideoWidth, \
						pdwVideoHeight,      \
						pdwPictAspectRatioX, \
						pdwPictAspectRatioY) \
	(This)->lpVtbl->GetNativeVideoProps(This, pdwVideoWidth,     \
					    pdwVideoHeight,          \
					    pdwPictAspectRatioX,     \
					    pdwPictAspectRatioY)
...
#define IDDrawExclModeVideoCallback_OnUpdateOverlay(This, bBefore, dwFlags,  \
						    bOldVisible, prcOldSrc,  \
...
#define IDDrawExclModeVideoCallback_OnUpdateSize(This, dwWidth, dwHeight, \
	...
	(This)->lpVtbl->OnUpdateSize(This, dwWidth, dwHeight, dwARWidth,  \
				     dwARHeight)
...
#define IGraphConfig_Reconnect(This, pOutputPin, pInputPin,                   \
			       ...
			       dwFlags)                                       \
	(This)->lpVtbl->Reconnect(This, pOutputPin, pInputPin,                \
				  pmtFirstConnection, pUsingFilter,           \
				  hAbortEvent, dwFlags)
...
#define IGraphConfig_PushThroughData(This, pOutputPin, pConnection,    \
				     hEventAbort)                      \
	(This)->lpVtbl->PushThroughData(This, pOutputPin, pConnection, \
					hEventAbort)
...
#define IVMRSurfaceAllocator_PrepareSurface(This, dwUserID, lpSurface, \
					    dwSurfaceFlags)            \
	(This)->lpVtbl->PrepareSurface(This, dwUserID, lpSurface,      \
				       dwSurfaceFlags)
...
#define IVMRDeinterlaceControl_GetNumberOfDeinterlaceModes(                    \
	...
	(This)->lpVtbl->GetNumberOfDeinterlaceModes(This, lpVideoDescription,  \
...
#define IVMRDeinterlaceControl_GetDeinterlaceModeCaps(                  \
	...
	(This)->lpVtbl->GetDeinterlaceModeCaps(This, lpDeinterlaceMode, \
					       lpVideoDescription,      \
					       lpDeinterlaceCaps)
...
#define IVMRImageCompositor_InitCompositionTarget(This, pD3DDevice, \
						  pddsRenderTarget) \
	(This)->lpVtbl->InitCompositionTarget(This, pD3DDevice,     \
					      pddsRenderTarget)

#define IVMRImageCompositor_TermCompositionTarget(This, pD3DDevice, \
						  pddsRenderTarget) \
	(This)->lpVtbl->TermCompositionTarget(This, pD3DDevice,     \
					      pddsRenderTarget)
...
#define IVMRImageCompositor_CompositeImage(This, pD3DDevice, pddsRenderTarget, \
					   pmtRenderTarget, rtStart, rtEnd,    \
					   dwClrBkGnd, pVideoStreamInfo,       \
					   cStreams)                           \
