...
#define IVMRSurfaceAllocator9_InitializeDevice(This, dwUserID, lpAllocInfo, \
					       lpNumBuffers)                \
	(This)->lpVtbl->InitializeDevice(This, dwUserID, lpAllocInfo,       \
					 lpNumBuffers)
...
HRESULT STDMETHODCALLTYPE IVMRSurface9_IsSurfaceLocked_Proxy(IVMRSurface9 *This);
...
#define IVMRImageCompositor9_CompositeImage(This, pD3DDevice,                  \
					    pddsRenderTarget, pmtRenderTarget, \
					    rtStart, rtEnd, dwClrBkGnd,        \
