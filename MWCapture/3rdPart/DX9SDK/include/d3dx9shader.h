...
DECLARE_INTERFACE_(ID3DXConstantTable, IUnknown)
{
	...
	(THIS_ D3DXHANDLE hConstant, D3DXCONSTANT_DESC * pConstantDesc,
	 UINT * pCount) PURE;
	...
	(THIS_ LPDIRECT3DDEVICE9 pDevice, D3DXHANDLE hConstant,
	 CONST FLOAT * pf, UINT Count) PURE;
	STDMETHOD(SetVector)
	(THIS_ LPDIRECT3DDEVICE9 pDevice, D3DXHANDLE hConstant,
...
DECLARE_INTERFACE_(ID3DXTextureShader, IUnknown)
{
	...
	(THIS_ LPD3DXBUFFER * ppConstantBuffer) PURE;
	...
	STDMETHOD(SetVectorArray)
	(THIS_ D3DXHANDLE hConstant, CONST D3DXVECTOR4 * pVector, UINT Count)
		PURE;
	STDMETHOD(SetMatrix)
...
{
	STDMETHOD(Open)
	(THIS_ D3DXINCLUDE_TYPE IncludeType, LPCSTR pFileName,
...
HRESULT WINAPI
D3DXGetShaderConstantTableEx(CONST DWORD *pFunction, DWORD Flags,
			     LPD3DXCONSTANTTABLE *ppConstantTable);
