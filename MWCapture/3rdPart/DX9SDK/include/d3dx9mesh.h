...
typedef enum _D3DXCLEANTYPE {
	...
	// Helper options
	D3DXCLEAN_SKINNING =
		D3DXCLEAN_BACKFACING, // Bowtie cleaning modifies geometry and breaks skinning
...
DECLARE_INTERFACE_(ID3DXBaseMesh, IUnknown)
{
	...
	(THIS_ D3DXATTRIBUTERANGE * pAttribTable, DWORD * pAttribTableSize)
		PURE;
	...
	STDMETHOD(GenerateAdjacency)
	(THIS_ FLOAT Epsilon, DWORD * pAdjacency) PURE;
...
DECLARE_INTERFACE_(ID3DXPatchMesh, IUnknown)
{
	...
	(THIS_ CONST D3DXVECTOR4 * pTrans, DWORD dwMaxTessLevel,
	 DWORD dwMinTessLevel, LPD3DXMESH pMesh) PURE;
};
...
DECLARE_INTERFACE_(ID3DXSkinInfo, IUnknown)
{
	...
	(THIS_ DWORD boneNum, DWORD influenceNum, float *pWeight,
	 DWORD *pVertexNum) PURE;
	STDMETHOD(GetMaxVertexInfluences)
	(THIS_ DWORD * maxVertexInfluences) PURE;
	...
	(THIS_ LPDIRECT3DINDEXBUFFER9 pIB, DWORD NumFaces,
	...
	(THIS_ DWORD Bone)
		PURE; // A pointer to an internal string buffer is returned. Do not free this.
	...
	STDMETHOD(SetDeclaration)
	(THIS_ CONST D3DVERTEXELEMENT9 * pDeclaration) PURE;
	STDMETHOD_(DWORD, GetFVF)(THIS) PURE;
	STDMETHOD(GetDeclaration)
	(THIS_ D3DVERTEXELEMENT9 Declaration[MAX_FVF_DECL_SIZE]) PURE;
...
HRESULT WINAPI D3DXLoadSkinMeshFromXof(
	...
	LPD3DXBUFFER *ppEffectInstances, DWORD *pMatOut,
	LPD3DXSKININFO *ppSkinInfo, LPD3DXMESH *ppMesh);
...
HRESULT WINAPI
D3DXCreatePatchMesh(CONST D3DXPATCHINFO *pInfo,     //patch type
...
HRESULT WINAPI D3DXIntersect(
	LPD3DXBASEMESH pMesh, CONST D3DXVECTOR3 *pRayPos,
	...
	LPD3DXBUFFER *
		ppAllHits, // Array of D3DXINTERSECTINFOs for all hits (not just closest)
	DWORD *pCountOfHits); // Number of entries in AllHits array

HRESULT WINAPI D3DXIntersectSubset(
	LPD3DXBASEMESH pMesh, DWORD AttribId, CONST D3DXVECTOR3 *pRayPos,
	CONST D3DXVECTOR3 *pRayDir,
	BOOL *pHit,        // True if any faces were intersected
	DWORD *pFaceIndex, // index of closest face intersected
	FLOAT *pU,         // Barycentric Hit Coordinates
...
HRESULT WINAPI D3DXComputeIMTFromPerTexelSignal(
	LPD3DXMESH pMesh, DWORD dwTextureIndex, FLOAT *pfTexelSignal,
	UINT uWidth, UINT uHeight, UINT uSignalDimension, UINT uComponents,
	DWORD dwOptions, LPD3DXUVATLASCB pStatusCallback, LPVOID pUserContext,
	LPD3DXBUFFER *ppIMTData);
...
DECLARE_INTERFACE_(ID3DXTextureGutterHelper, IUnknown)
{
	...
	(THIS_ LPDIRECT3DTEXTURE9 pTextureIn, LPD3DXMESH pMeshIn,
	 D3DDECLUSAGE Usage, UINT UsageIndex, LPDIRECT3DTEXTURE9 pTextureOut);
...
DECLARE_INTERFACE_(ID3DXPRTEngine, IUnknown)
{
	...
	(THIS_ CONST D3DXSHMATERIAL * *ppMaterials, UINT NumMeshes,
	...
	STDMETHOD(GetVertexAlbedo)
	(THIS_ D3DXCOLOR * pVertColors, UINT NumVerts) PURE;
	...
	STDMETHOD(SetPerTexelNormal)
	(THIS_ LPDIRECT3DTEXTURE9 pNormalTexture) PURE;
	...
	STDMETHOD(RobustMeshRefine)
	(THIS_ FLOAT MinEdgeLength, UINT MaxSubdiv) PURE;
	...
	(THIS_ LPD3DXSHPRTSIMCB pCB, FLOAT Frequency, LPVOID lpUserContext)
		PURE;
