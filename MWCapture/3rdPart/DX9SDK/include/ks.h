...
#define STATIC_GUID_NULL                                                       \
	0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
		0x00
...
#define STATIC_KSPROPTYPESETID_General                                         \
	0x97E99BA0L, 0xBDEA, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSPROPSETID_General                                             \
	0x1464EDA5L, 0x6A8F, 0x11D1, 0x9A, 0xA7, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define DEFINE_KSPROPERTY_ITEM_GENERAL_COMPONENTID(Handler)               \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_GENERAL_COMPONENTID, (Handler), \
			       sizeof(KSPROPERTY), sizeof(KSCOMPONENTID), \
			       NULL, NULL, 0, NULL, NULL, 0)

#define STATIC_KSMETHODSETID_StreamIo                                          \
	0x65D003CAL, 0x1523, 0x11D2, 0xB2, 0x7A, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define DEFINE_KSMETHOD_ITEM_STREAMIO_READ(Handler)                       \
	DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMIO_READ, KSMETHOD_TYPE_WRITE, \
			     (Handler), sizeof(KSMETHOD), 0, NULL)

#define DEFINE_KSMETHOD_ITEM_STREAMIO_WRITE(Handler)                      \
	DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMIO_WRITE, KSMETHOD_TYPE_READ, \
			     (Handler), sizeof(KSMETHOD), 0, NULL)

#define STATIC_KSPROPSETID_MediaSeeking                                        \
	0xEE904F0CL, 0xD09B, 0x11D0, 0xAB, 0xE9, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CAPABILITIES(Handler)              \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CAPABILITIES,           \
			       (Handler), sizeof(KSPROPERTY),                  \
			       sizeof(KS_SEEKING_CAPABILITIES), NULL, NULL, 0, \
			       NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_FORMATS(Handler)               \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_FORMATS, (Handler), \
			       sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, \
			       NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_TIMEFORMAT(GetHandler, SetHandler) \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_TIMEFORMAT,             \
			       (GetHandler), sizeof(KSPROPERTY), sizeof(GUID), \
			       (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITION(Handler)               \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITION, (Handler), \
			       sizeof(KSPROPERTY), sizeof(LONGLONG), NULL,  \
			       NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_STOPPOSITION(Handler)    \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_STOPPOSITION, \
			       (Handler), sizeof(KSPROPERTY),        \
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITIONS(Handler)                \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITIONS, NULL,       \
			       sizeof(KSPROPERTY),                            \
			       sizeof(KSPROPERTY_POSITIONS), (Handler), NULL, \
			       0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_AVAILABLE(Handler)                \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_AVAILABLE, (Handler),  \
			       sizeof(KSPROPERTY),                            \
			       sizeof(KSPROPERTY_MEDIAAVAILABLE), NULL, NULL, \
			       0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CONVERTTIMEFORMAT(Handler)    \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CONVERTTIMEFORMAT, \
			       (Handler), sizeof(KSP_TIMEFORMAT),         \
			       sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)

//===========================================================================

#define STATIC_KSPROPSETID_Topology                                            \
	0x720D4AC0L, 0x7533, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_NAME(Handler)                          \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_NAME, (Handler),            \
			       sizeof(KSP_NODE), 0, NULL, NULL, 0, NULL, NULL, \
			       0)
...
#define STATIC_KSPROPSETID_GM                                                  \
	0xAF627536L, 0xE719, 0x11D2, 0x8A, 0x1D, 0x00, 0x60, 0x97, 0xD2, 0xDF, \
		0x5D
...
#define STATIC_KSCATEGORY_BRIDGE                                               \
	0x085AFF00L, 0x62CE, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSCATEGORY_DATADECOMPRESSOR                                     \
	0x2721AE20L, 0x7E70, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSCATEGORY_DATATRANSFORM                                        \
	0x2EB07EA0L, 0x7E70, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSCATEGORY_COMMUNICATIONSTRANSFORM                              \
	0xCF1DDA2CL, 0x9743, 0x11D0, 0xA3, 0xEE, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSCATEGORY_INTERFACETRANSFORM                                   \
	0xCF1DDA2DL, 0x9743, 0x11D0, 0xA3, 0xEE, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSCATEGORY_MEDIUMTRANSFORM                                      \
	0xCF1DDA2EL, 0x9743, 0x11D0, 0xA3, 0xEE, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSCATEGORY_FILESYSTEM                                           \
	0x760FED5EL, 0x9357, 0x11D0, 0xA3, 0xCC, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSTIME_FORMAT_FRAME                                             \
	0x7b785570L, 0x8c82, 0x11cf, 0xbc, 0x0c, 0x00, 0xaa, 0x00, 0xac, 0x74, \
		0xf6
...
#define STATIC_KSTIME_FORMAT_BYTE                                              \
	0x7b785571L, 0x8c82, 0x11cf, 0xbc, 0x0c, 0x00, 0xaa, 0x00, 0xac, 0x74, \
		0xf6
...
#define STATIC_KSTIME_FORMAT_SAMPLE                                            \
	0x7b785572L, 0x8c82, 0x11cf, 0xbc, 0x0c, 0x00, 0xaa, 0x00, 0xac, 0x74, \
		0xf6
...
#define STATIC_KSTIME_FORMAT_FIELD                                             \
	0x7b785573L, 0x8c82, 0x11cf, 0xbc, 0x0c, 0x00, 0xaa, 0x00, 0xac, 0x74, \
		0xf6
...
#define STATIC_KSTIME_FORMAT_MEDIA_TIME                                        \
	0x7b785574L, 0x8c82, 0x11cf, 0xbc, 0x0c, 0x00, 0xaa, 0x00, 0xac, 0x74, \
		0xf6
...
#define STATIC_KSINTERFACESETID_Standard                                       \
	0x1A8766A0L, 0x62CE, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSINTERFACESETID_FileIo                                         \
	0x8C6F932CL, 0xE771, 0x11D0, 0xB8, 0xFF, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSPROPSETID_Pin                                                 \
	0x8C134960L, 0x51AD, 0x11CF, 0x87, 0x8A, 0x94, 0xF8, 0x01, 0xC1, 0x00, \
		0x00
...
typedef NTSTATUS (*PFNKSINTERSECTHANDLEREX)(
	IN PVOID Context, IN PIRP Irp, IN PKSP_PIN Pin,
	IN PKSDATARANGE DataRange, IN PKSDATARANGE MatchingDataRange,
	IN ULONG DataBufferSize, OUT PVOID Data OPTIONAL, OUT PULONG DataSize);
#endif // _NTDDK_
...
#define DEFINE_KSPROPERTY_ITEM_PIN_NECESSARYINSTANCES(Handler)                \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NECESSARYINSTANCES, (Handler),  \
			       sizeof(KSP_PIN), sizeof(ULONG), NULL, NULL, 0, \
			       NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_PIN_CATEGORY(Handler)                         \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CATEGORY, (Handler),           \
			       sizeof(KSP_PIN), sizeof(GUID), NULL, NULL, 0, \
			       NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_NAME(Handler)                              \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NAME, (Handler),                \
			       sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, NULL, \
			       0)

#define DEFINE_KSPROPERTY_ITEM_PIN_CONSTRAINEDDATARANGES(Handler)            \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CONSTRAINEDDATARANGES,         \
			       (Handler), sizeof(KSP_PIN), 0, NULL, NULL, 0, \
			       NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_PROPOSEDATAFORMAT(Handler)          \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_PROPOSEDATAFORMAT, NULL, \
			       sizeof(KSP_PIN), sizeof(KSDATAFORMAT),  \
...
#define STATIC_KSNAME_Filter                                                   \
	0x9b365890L, 0x165f, 0x11d0, 0xa1, 0x95, 0x00, 0x20, 0xaf, 0xd1, 0x56, \
		0xe4
...
#define STATIC_KSNAME_Pin                                                      \
	0x146F1A80L, 0x4791, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSNAME_Allocator                                                \
	0x642F5D00L, 0x4791, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSNAME_TopologyNode                                             \
	0x0621061AL, 0xEE75, 0x11D0, 0xB9, 0x15, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define DEFINE_KSPIN_DESCRIPTOR_ITEMEX(InterfacesCount, Interfaces,            \
				       MediumsCount, Mediums, DataRangesCount, \
				       DataRanges, DataFlow, Communication,    \
				       Category, Name)                         \
	{                                                                      \
...
#define STATIC_KSDATAFORMAT_TYPE_STREAM                                        \
	0xE436EB83L, 0x524F, 0x11CE, 0x9F, 0x53, 0x00, 0x20, 0xAF, 0x0B, 0xA7, \
		0x70
...
#define STATIC_KSDATAFORMAT_SUBTYPE_NONE                                       \
	0xE436EB8EL, 0x524F, 0x11CE, 0x9F, 0x53, 0x00, 0x20, 0xAF, 0x0B, 0xA7, \
		0x70
...
#define STATIC_KSDATAFORMAT_SPECIFIER_FILENAME                                 \
	0xAA797B40L, 0xE974, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSDATAFORMAT_SPECIFIER_FILEHANDLE                               \
	0x65E8773CL, 0x8F56, 0x11D0, 0xA3, 0xB9, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSDATAFORMAT_SPECIFIER_NONE                                     \
	0x0F6417D6L, 0xC318, 0x11D0, 0xA4, 0x3F, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_KSPROPSETID_Quality                                             \
	0xD16AD380L, 0xAC1A, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define DEFINE_KSPROPERTY_ITEM_QUALITY_REPORT(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_REPORT, (GetHandler), \
			       sizeof(KSPROPERTY), sizeof(KSQUALITY),   \
			       (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_QUALITY_ERROR(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_ERROR, (GetHandler), \
			       sizeof(KSPROPERTY), sizeof(KSERROR),    \
			       (SetHandler), NULL, 0, NULL, NULL, 0)

//===========================================================================

#define STATIC_KSPROPSETID_Connection                                          \
	0x1D58C920L, 0xAC9B, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PRIORITY(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PRIORITY, (GetHandler), \
			       sizeof(KSPROPERTY), sizeof(KSPRIORITY),       \
			       (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_DATAFORMAT(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_DATAFORMAT, (GetHandler), \
			       sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0,   \
			       NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ALLOCATORFRAMING(Handler)        \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ALLOCATORFRAMING,     \
			       (Handler), sizeof(KSPROPERTY),              \
			       sizeof(KSALLOCATOR_FRAMING), NULL, NULL, 0, \
			       NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ALLOCATORFRAMING_EX(Handler)       \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ALLOCATORFRAMING_EX,    \
			       (Handler), sizeof(KSPROPERTY), 0, NULL, NULL, \
			       0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PROPOSEDATAFORMAT(Handler)          \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PROPOSEDATAFORMAT, NULL, \
			       sizeof(KSPROPERTY), sizeof(KSDATAFORMAT),      \
			       (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ACQUIREORDERING(Handler)         \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ACQUIREORDERING,      \
			       (Handler), sizeof(KSPROPERTY), sizeof(int), \
			       NULL, NULL, 0, NULL, NULL, 0)
...
#define STATIC_KSMEMORY_TYPE_SYSTEM                                            \
	0x091bb638L, 0x603f, 0x11d1, 0xb0, 0x67, 0x00, 0xa0, 0xc9, 0x06, 0x28, \
		0x02
...
#define STATIC_KSMEMORY_TYPE_USER                                              \
	0x8cb0fc28L, 0x7893, 0x11d1, 0xb0, 0x69, 0x00, 0xa0, 0xc9, 0x06, 0x28, \
		0x02
...
#define STATIC_KSMEMORY_TYPE_KERNEL_PAGED                                      \
	0xd833f8f8L, 0x7894, 0x11d1, 0xb0, 0x69, 0x00, 0xa0, 0xc9, 0x06, 0x28, \
		0x02
...
#define STATIC_KSMEMORY_TYPE_DEVICE_UNKNOWN                                    \
	0x091bb639L, 0x603f, 0x11d1, 0xb0, 0x67, 0x00, 0xa0, 0xc9, 0x06, 0x28, \
		0x02
...
#define SetKsFramingRangeWeighted(KsFramingRangeWeightedPointer,     \
	...
	{                                                            \
		...
		SetKsFramingRange(KsFramingRange, P_MinFrameSize,    \
				  P_MaxFrameSize);                   \
...
#define STATIC_KSEVENTSETID_StreamAllocator                                    \
	0x75d95571L, 0x073c, 0x11d0, 0xa1, 0x61, 0x00, 0x20, 0xaf, 0xd1, 0x56, \
		0xe4
...
#define STATIC_KSMETHODSETID_StreamAllocator                                   \
	0xcf6e4341L, 0xec87, 0x11cf, 0xa1, 0x30, 0x00, 0x20, 0xaf, 0xd1, 0x56, \
		0xe4
...
#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_ALLOC(Handler)                    \
	DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_ALLOC,                   \
			     KSMETHOD_TYPE_WRITE, (Handler), sizeof(KSMETHOD), \
			     sizeof(PVOID), NULL)

#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_FREE(Handler)                    \
	DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_FREE,                   \
			     KSMETHOD_TYPE_READ, (Handler), sizeof(KSMETHOD), \
			     sizeof(PVOID), NULL)
...
#define STATIC_KSPROPSETID_StreamAllocator                                     \
	0xcf6e4342L, 0xec87, 0x11cf, 0xa1, 0x30, 0x00, 0x20, 0xaf, 0xd1, 0x56, \
		0xe4
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(Handler)         \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMALLOCATOR_FUNCTIONTABLE,      \
			       (Handler), sizeof(KSPROPERTY),                 \
			       sizeof(KSSTREAMALLOCATOR_FUNCTIONTABLE), NULL, \
			       NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(Handler)               \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMALLOCATOR_STATUS, (Handler), \
			       sizeof(KSPROPERTY),                           \
			       sizeof(KSSTREAMALLOCATOR_STATUS), NULL, NULL, \
			       0, NULL, NULL, 0)
...
#define STATIC_KSPROPSETID_StreamInterface                                     \
	0x1fdd8ee1L, 0x9cd3, 0x11d0, 0x82, 0xaa, 0x00, 0x00, 0xf8, 0x22, 0xfe, \
		0x8a
...
#define DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE(GetHandler) \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMINTERFACE_HEADERSIZE, \
...
#define DEFINE_KSPROPERTY_STREAMINTERFACESET(StreamInterfaceSet,   \
	...
	{                                                          \
		DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE( \
			HeaderSizeHandler)                         \
	}

#define STATIC_KSPROPSETID_Stream                                              \
	0x65aaba60L, 0x98ae, 0x11cf, 0xa1, 0x0d, 0x00, 0x20, 0xaf, 0xd1, 0x56, \
		0xe4
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_ALLOCATOR(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_ALLOCATOR, (GetHandler), \
			       sizeof(KSPROPERTY), sizeof(HANDLE),        \
			       (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_QUALITY(Handler)                        \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_QUALITY, (Handler),          \
			       sizeof(KSPROPERTY), sizeof(KSQUALITY_MANAGER), \
			       NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_TIMEFORMAT(Handler)                    \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_TIMEFORMAT, (Handler),      \
			       sizeof(KSPROPERTY), sizeof(GUID), NULL, NULL, \
			       0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PRESENTATIONTIME(GetHandler, SetHandler) \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PRESENTATIONTIME,             \
			       (GetHandler), sizeof(KSPROPERTY),               \
			       sizeof(KSTIME), (SetHandler), NULL, 0, NULL,    \
			       NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PRESENTATIONEXTENT(Handler)    \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PRESENTATIONEXTENT, \
			       (Handler), sizeof(KSPROPERTY),        \
			       sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_FRAMETIME(Handler)                      \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_FRAMETIME, (Handler),        \
			       sizeof(KSPROPERTY), sizeof(KSFRAMETIME), NULL, \
			       NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATECAPABILITY(Handler)               \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATECAPABILITY, (Handler), \
			       sizeof(KSRATE_CAPABILITY), sizeof(KSRATE),   \
			       NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATE(GetHandler, SetHandler)   \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATE, (GetHandler), \
			       sizeof(KSPROPERTY), sizeof(KSRATE),   \
			       (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define STATIC_KSPROPSETID_Clock                                               \
	0xDF12A4C0L, 0xAC17, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define DEFINE_KSPROPERTY_ITEM_CLOCK_TIME(Handler)                         \
	DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_TIME, (Handler),           \
			       sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, \
			       NULL, 0, NULL, NULL, 0)
...
#define STATIC_KSEVENTSETID_Clock                                              \
	0x364D8E20L, 0x62C7, 0x11CF, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define STATIC_KSEVENTSETID_Connection                                         \
	0x7f4bcbe0L, 0x9ea5, 0x11cf, 0xa5, 0xd6, 0x28, 0xdb, 0x04, 0xc1, 0x00, \
		0x00
...
#define STATIC_KSDEGRADESETID_Standard                                         \
	0x9F564180L, 0x704C, 0x11D0, 0xA5, 0xD6, 0x28, 0xDB, 0x04, 0xC1, 0x00, \
		0x00
...
#define DEFINE_KSPROPERTY_ITEM(PropertyId, GetHandler, MinProperty, MinData,  \
	...
	{                                                                     \
		PropertyId, (PFNKSHANDLER)GetHandler, MinProperty, MinData,   \
			(PFNKSHANDLER)SetHandler, (PKSPROPERTY_VALUES)Values, \
			RelationsCount, (PKSPROPERTY)Relations,               \
	...
	{                                                         \
		(DispatchCreate), (PVOID)(Context),               \
			{sizeof(TypeName) - sizeof(UNICODE_NULL), \
			 sizeof(TypeName), (PWCHAR)(TypeName)},   \
			NULL, 0                                   \
	}
...
#define DEFINE_KSDISPATCH_TABLE(tablename, DeviceIoControl, Read, Write,  \
	...
	const KSDISPATCH_TABLE tablename = {                              \
		...
		Write,           Flush,                                   \
		Close,           QuerySecurity,                           \
		SetSecurity,     FastDeviceIoControl,                     \
		FastRead,        FastWrite,                               \
	}
...
#define STATIC_GUID_BUS_INTERFACE_MEDIUMS                                      \
	0x4EC35C3EL, 0x201B, 0x11D2, 0x87, 0x45, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
BOOLEAN __inline KsGateCaptureThreshold(IN PKSGATE Gate)
{
	...
	captured =
		(BOOLEAN)(InterlockedCompareExchange(&Gate->Count, 0, 1) == 1);
...
DECLARE_INTERFACE_(IKsControl, IUnknown)
{
	...
	(THIS_ IN PKSPROPERTY Property, IN ULONG PropertyLength,
	 IN OUT PVOID PropertyData, IN ULONG DataLength,
	 OUT ULONG * BytesReturned) PURE;
	STDMETHOD_(NTSTATUS, KsMethod)
	(THIS_ IN PKSMETHOD Method, IN ULONG MethodLength,
	 IN OUT PVOID MethodData, IN ULONG DataLength,
	 OUT ULONG * BytesReturned) PURE;
	STDMETHOD_(NTSTATUS, KsEvent)
	(THIS_ IN PKSEVENT Event OPTIONAL, IN ULONG EventLength,
	 IN OUT PVOID EventData, IN ULONG DataLength, OUT ULONG * BytesReturned)
		PURE;
};
...
DECLARE_INTERFACE_(IKsReferenceClock, IUnknown)
{
	...
	(THIS_ OUT PKSRESOLUTION Resolution) PURE;
	STDMETHOD_(NTSTATUS, GetState)(THIS_ OUT PKSSTATE State) PURE;
};
#undef INTERFACE

#define STATIC_IID_IKsControl                                                  \
	0x28F54685L, 0x06FD, 0x11D2, 0xB2, 0x7A, 0x00, 0xA0, 0xC9, 0x22, 0x31, \
		0x96
...
#define STATIC_IID_IKsFastClock                                               \
	0xc9902485, 0xc180, 0x11d2, 0x84, 0x73, 0xd4, 0x23, 0x94, 0x45, 0x9e, \
		0x5e
...
#define KsEditSized(Object, PointerToPointer, NewSize, OldSize, Tag)   \
	_KsEdit((Object)->Bag, (PVOID *)(PointerToPointer), (NewSize), \
		(OldSize), (Tag))
...
{
	return KsRegisterAggregatedClientUnknown((PVOID)FilterFactory,
						 ClientUnknown);
}
