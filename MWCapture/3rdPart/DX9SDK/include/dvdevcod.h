...
typedef enum _tagDVD_ERROR {
	DVD_ERROR_Unexpected =
		1, // Something unexpected happened, perhaps content
		   //   is incorrectly authored.  Playback is stopped.
	DVD_ERROR_CopyProtectFail =
		2, // Key exchange for DVD copy protection failed.
		   //   Playback is stopped.
	...
	DVD_ERROR_InvalidDiscRegion =
		4, // The Disc cannot be played because the disc is not
...
typedef enum _tagDVD_PB_STOPPED {
	...
	DVD_PB_STOPPED_NoBranch =
		1, // The nav completed the current pgc and there was no more video and
	...
	DVD_PB_STOPPED_StopCommand =
		3, // The app issued a stop() command or a stop command was authored on the disc.
	DVD_PB_STOPPED_Reset =
		4, // The navigator was reset to the start of the disc (using ResetOnStop).
	...
	DVD_PB_STOPPED_RegionFailure =
		10, // A region failure prevented playback
