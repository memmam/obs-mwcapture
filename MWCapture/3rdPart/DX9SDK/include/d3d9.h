...
DECLARE_INTERFACE_(IDirect3D9, IUnknown)
{
	...
	(THIS_ UINT Adapter, D3DFORMAT Format, UINT Mode,
...
DECLARE_INTERFACE_(IDirect3DDevice9, IUnknown)
{
	...
	(THIS_ UINT Width, UINT Height, UINT Levels, DWORD Usage,
	...
	(THIS_ UINT StartRegister, CONST float *pConstantData,
...
DECLARE_INTERFACE_(IDirect3DResource9, IUnknown)
{
	...
	(THIS_ REFGUID refguid, CONST void *pData, DWORD SizeOfData,
	 DWORD Flags) PURE;
...
DECLARE_INTERFACE_(IDirect3DCubeTexture9, IDirect3DBaseTexture9)
{
	...
	STDMETHOD(LockRect)
	(THIS_ D3DCUBEMAP_FACES FaceType, UINT Level,
	 D3DLOCKED_RECT * pLockedRect, CONST RECT * pRect, DWORD Flags) PURE;
...
DECLARE_INTERFACE_(IDirect3D9Ex, IDirect3D9)
{
	...
	(THIS_ UINT Adapter, D3DDISPLAYMODEEX * pMode,
...
DECLARE_INTERFACE_(IDirect3DAuthenticatedChannel9, IUnknown)
{
	...
	STDMETHOD(Query)
	(THIS_ UINT InputSize, CONST VOID * pInput, UINT OutputSize,
	 VOID * pOutput) PURE;
	STDMETHOD(Configure)
