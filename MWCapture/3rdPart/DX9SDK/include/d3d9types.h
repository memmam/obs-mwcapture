...
#define D3DCS_ALL                                                            \
	(D3DCS_LEFT | D3DCS_RIGHT | D3DCS_TOP | D3DCS_BOTTOM | D3DCS_FRONT | \
	 D3DCS_BACK | D3DCS_PLANE0 | D3DCS_PLANE1 | D3DCS_PLANE2 |           \
	 D3DCS_PLANE3 | D3DCS_PLANE4 | D3DCS_PLANE5)
...
typedef enum _D3DRENDERSTATETYPE {
	...
	D3DRS_POSITIONDEGREE =
		172, // NPatch position interpolation degree. D3DDEGREE_LINEAR or D3DDEGREE_CUBIC (default)
	D3DRS_NORMALDEGREE =
		173, // NPatch normal interpolation degree. D3DDEGREE_LINEAR (default) or D3DDEGREE_QUADRATIC
	...
	D3DRS_TWOSIDEDSTENCILMODE =
		185, /* BOOL enable/disable 2 sided stenciling */
	...
	D3DRS_CCW_STENCILFUNC =
		189, /* D3DCMPFUNC fn.  ccw Stencil Test passes if ((ref & mask) stencilfn (stencil & mask)) is true */
	D3DRS_COLORWRITEENABLE1 =
		190, /* Additional ColorWriteEnables for the devices that support D3DPMISCCAPS_INDEPENDENTWRITEMASKS */
	D3DRS_COLORWRITEENABLE2 =
		191, /* Additional ColorWriteEnables for the devices that support D3DPMISCCAPS_INDEPENDENTWRITEMASKS */
	D3DRS_COLORWRITEENABLE3 =
		192, /* Additional ColorWriteEnables for the devices that support D3DPMISCCAPS_INDEPENDENTWRITEMASKS */
	D3DRS_BLENDFACTOR =
		193, /* D3DCOLOR used for a constant blend factor during alpha blending for devices that support D3DPBLENDCAPS_BLENDFACTOR */
	D3DRS_SRGBWRITEENABLE =
		194, /* Enable rendertarget writes to be DE-linearized to SRGB (for formats that expose D3DUSAGE_QUERY_SRGBWRITE) */
	D3DRS_DEPTHBIAS = 195,
	D3DRS_WRAP8 =
		198, /* Additional wrap states for vs_3_0+ attributes with D3DDECLUSAGE_TEXCOORD */
	D3DRS_WRAP9 = 199,
	D3DRS_WRAP10 = 200,
	D3DRS_WRAP11 = 201,
	D3DRS_WRAP12 = 202,
	...
	D3DRS_SEPARATEALPHABLENDENABLE =
		206, /* TRUE to enable a separate blending function for the alpha channel */
	D3DRS_SRCBLENDALPHA =
		207, /* SRC blend factor for the alpha channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
	D3DRS_DESTBLENDALPHA =
		208, /* DST blend factor for the alpha channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
	D3DRS_BLENDOPALPHA =
		209, /* Blending operation for the alpha channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
...
typedef enum _D3DSAMPLERSTATETYPE {
	...
	D3DSAMP_MAGFILTER =
		5, /* D3DTEXTUREFILTER filter to use for magnification */
	D3DSAMP_MINFILTER =
		6, /* D3DTEXTUREFILTER filter to use for minification */
	D3DSAMP_MIPFILTER =
		7, /* D3DTEXTUREFILTER filter to use between mipmaps during minification */
	...
	D3DSAMP_DMAPOFFSET =
		13, /* Offset in vertices in the pre-sampled displacement map.
...
/* D3D9Ex only -- */
	...
	D3DTEXF_CONVOLUTIONMONO =
		8, // Convolution filter for monochrome textures
...
typedef enum _D3DDECLTYPE {
	...
	D3DDECLTYPE_FLOAT3 =
		2, // 3D float expanded to (value, value, value, 1.)
	...
	D3DDECLTYPE_SHORT4N =
		10, // 4D signed short normalized (v[0]/32767.0,v[1]/32767.0,v[2]/32767.0,v[3]/32767.0)
	D3DDECLTYPE_USHORT2N =
		11, // 2D unsigned short normalized (v[0]/65535.0,v[1]/65535.0,0,1)
	D3DDECLTYPE_USHORT4N =
		12, // 4D unsigned short normalized (v[0]/65535.0,v[1]/65535.0,v[2]/65535.0,v[3]/65535.0)
	D3DDECLTYPE_UDEC3 =
...
typedef enum _D3DSAMPLER_TEXTURE_TYPE {
	...
	D3DSTT_2D =
		2
		<< D3DSP_TEXTURETYPE_SHIFT, // dcl_2d s# (for declaring a 2-D texture)
	D3DSTT_CUBE =
		3
		<< D3DSP_TEXTURETYPE_SHIFT, // dcl_cube s# (for declaring a cube texture)
	D3DSTT_VOLUME =
		4
		<< D3DSP_TEXTURETYPE_SHIFT, // dcl_volume s# (for declaring a volume texture)
...
#define D3DSHADER_COMMENT(_DWordSize)                 \
	((((_DWordSize) << D3DSI_COMMENTSIZE_SHIFT) & \
...
typedef enum _D3DBASISTYPE {
	...
	D3DBASIS_CATMULL_ROM =
		2, /* In D3D8 this used to be D3DBASIS_INTERPOLATE */
...
#define D3DISSUE_END \
	(1           \
	 << 0) // Tells the runtime to issue the end of a query, changing it's state to "non-signaled".
...
typedef struct _D3DCOMPOSERECTDESTINATION {
	...
	SHORT X,
		Y; // Top-left coordinates of the rect in the destination surface
