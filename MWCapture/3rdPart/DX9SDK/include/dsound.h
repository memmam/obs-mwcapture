...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown)
{
	...
	(THIS_ LPDWORD pdwCurrentPlayCursor, LPDWORD pdwCurrentWriteCursor)
		PURE;
	STDMETHOD(GetFormat)
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer)
{
	...
	STDMETHOD(SetFX)
	(THIS_ DWORD dwEffectsCount, LPDSEFFECTDESC pDSFXDesc,
	 LPDWORD pdwResultCodes) PURE;
	STDMETHOD(AcquireResources)
	(THIS_ DWORD dwFlags, DWORD dwEffectsCount, LPDWORD pdwResultCodes)
		PURE;
...
DECLARE_INTERFACE_(IDirectSoundFXDistortion, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ LPCDSFXDistortion pcDsFxDistortion) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ LPDSFXDistortion pDsFxDistortion) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXCompressor, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ LPCDSFXCompressor pcDsFxCompressor) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ LPDSFXCompressor pDsFxCompressor) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXI3DL2Reverb, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ LPCDSFXI3DL2Reverb pcDsFxI3DL2Reverb) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ LPDSFXI3DL2Reverb pDsFxI3DL2Reverb) PURE;
...
DECLARE_INTERFACE_(IDirectSoundFXWavesReverb, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ LPCDSFXWavesReverb pcDsFxWavesReverb) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ LPDSFXWavesReverb pDsFxWavesReverb) PURE;
};
