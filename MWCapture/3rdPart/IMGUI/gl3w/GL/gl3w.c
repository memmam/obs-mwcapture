...
static void load_procs(void)
{
	gl3wMapTexture2DINTEL = (PFNGLMAPTEXTURE2DINTELPROC) get_proc("glMapTexture2DINTEL");
	gl3wSyncTextureINTEL = (PFNGLSYNCTEXTUREINTELPROC)get_proc("glSyncTextureINTEL");
	gl3wUnmapTexture2DINTEL = (PFNGLUNMAPTEXTURE2DINTELPROC)get_proc("glUnmapTexture2DINTEL");
