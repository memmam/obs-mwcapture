...
typedef int
	ImGuiColorEditFlags; // -> enum ImGuiColorEditFlags_  // Flags: for ColorEdit*(), ColorPicker*()
typedef int
...
typedef int
	ImGuiDragDropFlags; // -> enum ImGuiDragDropFlags_   // Flags: for *DragDrop*()
typedef int
...
typedef int
	ImGuiInputTextFlags; // -> enum ImGuiInputTextFlags_  // Flags: for InputText*()
typedef int
...
typedef int
	ImGuiTreeNodeFlags; // -> enum ImGuiTreeNodeFlags_   // Flags: for TreeNode*(),CollapsingHeader()
typedef int
...
IMGUI_API bool MWButton(const char *label, const ImVec2 &size = ImVec2(0, 0),
			bool enable = true);
...
enum ImGuiColorEditFlags_ {
	...
	ImGuiColorEditFlags__PickerMask = ImGuiColorEditFlags_PickerHueWheel |
					  ImGuiColorEditFlags_PickerHueBar,
	ImGuiColorEditFlags__InputMask = ImGuiColorEditFlags_InputRGB |
					 ImGuiColorEditFlags_InputHSV
...
// Obsolete names (will be removed)
	...
	ImGuiSetCond_Appearing = ImGuiCond_Appearing // [renamed in 1.51]
#endif
};
