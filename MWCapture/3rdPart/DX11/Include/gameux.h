...
#define IGameExplorer_AddGame(This, bstrGDFBinaryPath,                   \
			      ...
			      pguidInstanceID)                           \
	((This)->lpVtbl->AddGame(This, bstrGDFBinaryPath,                \
				 bstrGameInstallDirectory, installScope, \
				 pguidInstanceID))
...
#define IGameStatistics_GetStatistic(This, categoryIndex, statIndex, pName,  \
				     pValue)                                 \
	((This)->lpVtbl->GetStatistic(This, categoryIndex, statIndex, pName, \
				      pValue))

#define IGameStatistics_SetStatistic(This, categoryIndex, statIndex, name,  \
				     value)                                 \
	((This)->lpVtbl->SetStatistic(This, categoryIndex, statIndex, name, \
				      value))
...
public:
	virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetGameStatistics(
		...
		/* [retval][out] */ __RPC__deref_out_opt IGameStatistics *
			*ppiStats) = 0;
...
unsigned char *__RPC_USER BSTR_UserUnmarshal(__RPC__in unsigned long *,
