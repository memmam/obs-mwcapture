...
struct CD3D11_BOX : public D3D11_BOX {
	...
	explicit CD3D11_BOX(LONG Left, LONG Top, LONG Front, LONG Right,
...
struct CD3D11_BLEND_DESC : public D3D11_BLEND_DESC {
	...
	explicit CD3D11_BLEND_DESC(CD3D11_DEFAULT)
	{
		...
		const D3D11_RENDER_TARGET_BLEND_DESC
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC
	...
	explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
		...
		UINT firstArraySlice =
			0,           // First2DArrayFace for TEXTURECUBEARRAY
		...
		UINT arraySize = -1) // NumCubes for TEXTURECUBEARRAY
	{
		...
		if (DXGI_FORMAT_UNKNOWN == format ||
			...
			if (-1 == arraySize) {
				arraySize = TexDesc.ArraySize - firstArraySlice;
				if (D3D11_SRV_DIMENSION_TEXTURECUBEARRAY ==
				    viewDimension)
					arraySize /= 6;
			}
		}
...
struct CD3D11_RENDER_TARGET_VIEW_DESC : public D3D11_RENDER_TARGET_VIEW_DESC {
	...
	explicit CD3D11_RENDER_TARGET_VIEW_DESC(
		__in ID3D11Texture3D *pTex3D,
		DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
		UINT firstWSlice = 0, UINT wSize = -1)
	{
...
struct CD3D11_VIEWPORT : public D3D11_VIEWPORT {
				 ...
				 FLOAT maxDepth = D3D11_MAX_DEPTH)
	{
		...
		const UINT SubResourceWidth =
			TexDesc.Width / (UINT(1) << MipSlice);
		TopLeftX = topLeftX;
		TopLeftY = 0.0f;
				 ...
				 FLOAT maxDepth = D3D11_MAX_DEPTH)
	{
		...
		const UINT SubResourceWidth =
			TexDesc.Width / (UINT(1) << MipSlice);
		const UINT SubResourceHeight =
			TexDesc.Height / (UINT(1) << MipSlice);
		TopLeftX = topLeftX;
		TopLeftY = topLeftY;
		Width = (SubResourceWidth ? SubResourceWidth : 1) - topLeftX;
...
struct CD3D11_UNORDERED_ACCESS_VIEW_DESC
	...
	~CD3D11_UNORDERED_ACCESS_VIEW_DESC() {}
	operator const D3D11_UNORDERED_ACCESS_VIEW_DESC &() const
	{
		return *this;
	}
};
...
#define ID3D11ClassLinkage_GetClassInstance(This, pClassInstanceName,  \
	...
	((This)->lpVtbl->GetClassInstance(This, pClassInstanceName,    \
					  InstanceIndex, ppInstance))
...
#define ID3D11ClassLinkage_CreateClassInstance(                           \
	...
	((This)->lpVtbl->CreateClassInstance(                             \
		This, pClassTypeName, ConstantBufferOffset,               \
...
public:
	...
	virtual void STDMETHODCALLTYPE PSSetShaderResources(
		...
		/* [annotation] */
		__in_ecount(NumViews) ID3D11ShaderResourceView *const
	...
	virtual void STDMETHODCALLTYPE OMGetRenderTargets(
		...
		__in_range(0, D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT)
			UINT NumViews,
		/* [annotation] */
		__out_ecount_opt(NumViews) ID3D11RenderTargetView *
			*ppRenderTargetViews,
		/* [annotation] */
	...
	virtual void STDMETHODCALLTYPE OMGetRenderTargetsAndUnorderedAccessViews(
		...
		__in_range(0, D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT)
			UINT NumRTVs,
		/* [annotation] */
		__out_ecount_opt(NumRTVs) ID3D11RenderTargetView *
			*ppRenderTargetViews,
		/* [annotation] */
		...
		__in_range(0, D3D11_PS_CS_UAV_REGISTER_COUNT - 1)
			UINT UAVStartSlot,
		/* [annotation] */
		__in_range(0, D3D11_PS_CS_UAV_REGISTER_COUNT - UAVStartSlot)
			UINT NumUAVs,
		/* [annotation] */
	...
	virtual void STDMETHODCALLTYPE RSGetViewports(
		/* [annotation] */
		__inout /*_range(0, D3D11_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE )*/
				UINT *
			pNumViewports,
		/* [annotation] */
		__out_ecount_opt(*pNumViewports) D3D11_VIEWPORT *
			pViewports) = 0;
...
#define ID3D11DeviceContext_OMSetRenderTargetsAndUnorderedAccessViews(       \
	...
	((This)->lpVtbl->OMSetRenderTargetsAndUnorderedAccessViews(          \
		This, NumRTVs, ppRenderTargetViews, pDepthStencilView,       \
...
#define ID3D11DeviceContext_DrawIndexedInstancedIndirect( \
	...
	((This)->lpVtbl->DrawIndexedInstancedIndirect(    \
		This, pBufferForArgs, AlignedByteOffsetForArgs))
...
#define ID3D11DeviceContext_CopySubresourceRegion(This, pDstResource,         \
...
#define ID3D11DeviceContext_UpdateSubresource(This, pDstResource,              \
...
#define ID3D11DeviceContext_CopyStructureCount(This, pDstBuffer,               \
	...
	((This)->lpVtbl->CopyStructureCount(This, pDstBuffer,                  \
					    DstAlignedByteOffset, pSrcView))
...
#define ID3D11DeviceContext_ClearUnorderedAccessViewUint( \
	...
	((This)->lpVtbl->ClearUnorderedAccessViewUint(    \
		This, pUnorderedAccessView, Values))
...
#define ID3D11DeviceContext_ResolveSubresource(This, pDstResource,           \
...
#define ID3D11DeviceContext_HSSetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->HSSetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
#define ID3D11DeviceContext_DSSetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->DSSetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
#define ID3D11DeviceContext_CSSetUnorderedAccessViews(                       \
	...
	((This)->lpVtbl->CSSetUnorderedAccessViews(This, StartSlot, NumUAVs, \
...
#define ID3D11DeviceContext_CSSetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->CSSetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
#define ID3D11DeviceContext_HSGetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->HSGetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
#define ID3D11DeviceContext_DSGetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->DSGetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
#define ID3D11DeviceContext_CSGetSamplers(This, StartSlot, NumSamplers, \
					  ppSamplers)                   \
	((This)->lpVtbl->CSGetSamplers(This, StartSlot, NumSamplers,    \
				       ppSamplers))
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE CreateGeometryShaderWithStreamOutput(
		...
		/* [annotation] */
		__in_range(0, D3D11_SO_STREAM_COUNT *
...
#define ID3D11Device_CreateUnorderedAccessView(This, pResource, pDesc,     \
					       ppUAView)                   \
	((This)->lpVtbl->CreateUnorderedAccessView(This, pResource, pDesc, \
						   ppUAView))
...
#define ID3D11Device_CreateGeometryShader(This, pShaderBytecode,             \
					  BytecodeLength, pClassLinkage,     \
					  ppGeometryShader)                  \
	((This)->lpVtbl->CreateGeometryShader(This, pShaderBytecode,         \
					      BytecodeLength, pClassLinkage, \
					      ppGeometryShader))
...
#define ID3D11Device_CreateDeferredContext(This, ContextFlags,     \
					   ppDeferredContext)      \
	((This)->lpVtbl->CreateDeferredContext(This, ContextFlags, \
					       ppDeferredContext))
