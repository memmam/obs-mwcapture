...
typedef struct XAPO_REGISTRATION_PROPERTIES {
	...
	WCHAR FriendlyName
		[XAPO_REGISTRATION_STRING_LENGTH]; // friendly name unicode string
	WCHAR CopyrightInfo
		[XAPO_REGISTRATION_STRING_LENGTH]; // copyright information unicode string
...
DECLARE_INTERFACE_(IXAPO, IUnknown)
{
	...
	(THIS_ __deref_out XAPO_REGISTRATION_PROPERTIES *
	 *ppRegistrationProperties) PURE;
	...
	(THIS_ __in_bcount_opt(DataByteSize) const void *pData,
...
#define IXAPO_GetRegistrationProperties(This, ppRegistrationProperties) \
	((This)->lpVtbl->GetRegistrationProperties(This,                \
...
#define IXAPO_LockForProcess(This, InputLockedParameterCount,            \
			     pInputLockedParameters,                     \
...
#define IXAPO_Process(This, InputProcessParameterCount,                     \
	...
	((This)->lpVtbl->Process(This, InputProcessParameterCount,          \
