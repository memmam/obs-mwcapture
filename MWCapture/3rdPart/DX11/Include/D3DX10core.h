...
DECLARE_INTERFACE_(ID3DX10Sprite, IUnknown)
{
	...
	(THIS_ D3DX10_SPRITE * pSprites, UINT cSprites, UINT cbSprite,
	 UINT flags) PURE;
...
DECLARE_INTERFACE_(ID3DX10ThreadPump, IUnknown)
{
	...
	(THIS_ ID3DX10DataLoader * pDataLoader,
	 ID3DX10DataProcessor * pDataProcessor, HRESULT * pHResult,
...
DECLARE_INTERFACE_(ID3DX10Font, IUnknown)
{
	...
	(THIS_ UINT Glyph, ID3D10ShaderResourceView * *ppTexture,
