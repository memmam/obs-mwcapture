...
typedef struct _D3D10_STATE_BLOCK_MASK {
	BYTE VS;
	BYTE VSSamplers[D3D10_BYTES_FROM_BITS(
	...
	BYTE GS;
	BYTE GSSamplers[D3D10_BYTES_FROM_BITS(
		D3D10_COMMONSHADER_SAMPLER_SLOT_COUNT)];
	...
	BYTE PS;
	BYTE PSSamplers[D3D10_BYTES_FROM_BITS(
		D3D10_COMMONSHADER_SAMPLER_SLOT_COUNT)];
...
DECLARE_INTERFACE(ID3D10EffectType)
{
	...
	STDMETHOD_(ID3D10EffectType *, GetMemberTypeByIndex)
	(THIS_ UINT Index) PURE;
	STDMETHOD_(ID3D10EffectType *, GetMemberTypeByName)
...
DECLARE_INTERFACE(ID3D10EffectVariable)
{
	...
	STDMETHOD_(ID3D10EffectVariable *, GetMemberByIndex)
	(THIS_ UINT Index) PURE;
	STDMETHOD_(ID3D10EffectVariable *, GetMemberByName)
	(THIS_ LPCSTR Name) PURE;
	...
	STDMETHOD_(ID3D10EffectConstantBuffer *, GetParentConstantBuffer)
	(THIS) PURE;
	...
	STDMETHOD_(ID3D10EffectShaderResourceVariable *, AsShaderResource)
	(THIS) PURE;
	...
	STDMETHOD_(ID3D10EffectDepthStencilVariable *, AsDepthStencil)
	(THIS) PURE;
...
DECLARE_INTERFACE_(ID3D10EffectVectorVariable, ID3D10EffectVariable)
{
	...
	(THIS_ int *pData, UINT Offset, UINT Count) PURE;
...
DECLARE_INTERFACE_(ID3D10EffectShaderResourceVariable, ID3D10EffectVariable)
{
	...
	(THIS_ ID3D10ShaderResourceView * *ppResource) PURE;

	STDMETHOD(SetResourceArray)
	(THIS_ ID3D10ShaderResourceView * *ppResources, UINT Offset, UINT Count)
		PURE;
...
DECLARE_INTERFACE_(ID3D10EffectRenderTargetViewVariable, ID3D10EffectVariable)
{
	...
	(THIS_ ID3D10RenderTargetView * pResource) PURE;
	STDMETHOD(GetRenderTarget)
	(THIS_ ID3D10RenderTargetView * *ppResource) PURE;

	STDMETHOD(SetRenderTargetArray)
	(THIS_ ID3D10RenderTargetView * *ppResources, UINT Offset, UINT Count)
		PURE;
...
DECLARE_INTERFACE_(ID3D10EffectDepthStencilViewVariable, ID3D10EffectVariable)
{
	...
	(THIS_ ID3D10DepthStencilView * pResource) PURE;
	STDMETHOD(GetDepthStencil)
	(THIS_ ID3D10DepthStencilView * *ppResource) PURE;

	STDMETHOD(SetDepthStencilArray)
	(THIS_ ID3D10DepthStencilView * *ppResources, UINT Offset, UINT Count)
		PURE;
...
DECLARE_INTERFACE_(ID3D10EffectConstantBuffer, ID3D10EffectVariable)
{
	...
	(THIS_ ID3D10Buffer * *ppConstantBuffer) PURE;
...
DECLARE_INTERFACE_(ID3D10EffectShaderVariable, ID3D10EffectVariable)
{
	...
	(THIS_ UINT ShaderIndex, UINT Element,
	 D3D10_SIGNATURE_PARAMETER_DESC * pDesc) PURE;
...
DECLARE_INTERFACE_(ID3D10EffectSamplerVariable, ID3D10EffectVariable)
{
	...
	(THIS_ UINT Index, ID3D10SamplerState * *ppSampler) PURE;
	STDMETHOD(GetBackingStore)
...
DECLARE_INTERFACE(ID3D10EffectPass)
{
	...
	(THIS_ D3D10_PASS_SHADER_DESC * pDesc) PURE;
...
DECLARE_INTERFACE_(ID3D10Effect, IUnknown)
{
	...
	STDMETHOD_(ID3D10EffectVariable *, GetVariableByIndex)
	(THIS_ UINT Index) PURE;
	STDMETHOD_(ID3D10EffectVariable *, GetVariableByName)
	(THIS_ LPCSTR Name) PURE;
