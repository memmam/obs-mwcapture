...
#define __RPC__deref_out_opt_string                                \
	__RPC__deref_out_opt __post __deref __nullterminated __pre \
		__deref __null
...
#define __RPC__deref_out_xcount_part_opt(size, length)                 \
	__RPC__deref_out __post __deref __exceptthat __maybenull __pre \
		__deref __null
...
#define __RPC__deref_opt_inout_opt_string                                \
	__RPC__deref_opt_inout_opt __pre __deref __nullterminated __post \
