...
#endif
{
	...
	_XMMATRIX(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m03, FLOAT m10,
...
typedef struct _XMFLOAT3X3 {
	...
	_XMFLOAT3X3(){};
	_XMFLOAT3X3(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m10, FLOAT m11,
...
typedef struct _XMFLOAT4X3 {
	...
	_XMFLOAT4X3(){};
	_XMFLOAT4X3(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m10, FLOAT m11,
...
__declspec(align(16)) struct XMFLOAT4X3A : public XMFLOAT4X3 {
	...
	XMFLOAT4X3A(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m10, FLOAT m11,
		    FLOAT m12, FLOAT m20, FLOAT m21, FLOAT m22, FLOAT m30,
		    FLOAT m31, FLOAT m32)
...
typedef struct _XMFLOAT4X4 {
	...
	_XMFLOAT4X4(){};
	_XMFLOAT4X4(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m03, FLOAT m10,
		    FLOAT m11, FLOAT m12, FLOAT m13, FLOAT m20, FLOAT m21,
		    FLOAT m22, FLOAT m23, FLOAT m30, FLOAT m31, FLOAT m32,
		    FLOAT m33);
...
__declspec(align(16)) struct XMFLOAT4X4A : public XMFLOAT4X4 {
	...
	XMFLOAT4X4A(FLOAT m00, FLOAT m01, FLOAT m02, FLOAT m03, FLOAT m10,
		    FLOAT m11, FLOAT m12, FLOAT m13, FLOAT m20, FLOAT m21,
		    FLOAT m22, FLOAT m23, FLOAT m30, FLOAT m31, FLOAT m32,
		    FLOAT m33)
...
XMGLOBALCONST XMVECTORF32 g_XMSinCoefficients2 = {2.811457254e-15f,
						  -8.220635247e-18f,
						  1.957294106e-20f,
						  -3.868170171e-23f};
...
XMGLOBALCONST XMVECTORF32 g_XMCosCoefficients2 = {4.779477332e-14f,
						  -1.561920697e-16f,
						  4.110317623e-19f,
						  -8.896791392e-22f};
...
XMGLOBALCONST XMVECTORF32 g_XMASinCoefficients0 = {-0.05806367563904f,
						   -0.41861972469416f,
						   0.22480114791621f,
						   2.17337241360606f};
XMGLOBALCONST XMVECTORF32 g_XMASinCoefficients1 = {0.61657275907170f,
						   4.29696498283455f,
						   -1.18942822255452f,
						   -6.53784832094831f};
XMGLOBALCONST XMVECTORF32 g_XMASinCoefficients2 = {-1.36926553863413f,
						   -4.48179294237210f,
						   1.41810672941833f,
						   5.48179257935713f};
...
XMGLOBALCONST XMVECTORF32 g_XMASinEstCoefficients = {-1.36178272886711f,
						     2.37949493464538f,
...
XMGLOBALCONST XMVECTORF32 g_XMFixAA2B10G10R10 = {-512.0f,
						 -512.0f * (float)(0x400),
...
XMFINLINE XMVECTOR XMVectorSplatConstant(INT IntConstant, UINT DivExponent)
{
	...
	{
		XMVECTORI32 V = {IntConstant, IntConstant, IntConstant,
				 IntConstant};
	...
	vResult = _mm_mul_ps(vResult,
			     reinterpret_cast<const __m128 *>(&vScale)[0]);
	return vResult;
#endif
}
...
XMFINLINE XMVECTOR XMVectorRotateLeft(FXMVECTOR V, UINT Elements)
{
	...
	XMASSERT(Elements < 4);
	{
		XMVECTORF32 vResult = {V.vector4_f32[Elements & 3],
				       V.vector4_f32[(Elements + 1) & 3],
				       V.vector4_f32[(Elements + 2) & 3],
				       V.vector4_f32[(Elements + 3) & 3]};
		return vResult.v;
	}
#else // XM_SSE_INTRINSICS_
