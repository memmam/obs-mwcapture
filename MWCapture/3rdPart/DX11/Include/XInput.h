...
DWORD WINAPI XInputGetBatteryInformation(
	...
	__out XINPUT_BATTERY_INFORMATION *
...
DWORD WINAPI XInputGetKeystroke(
	...
	__out PXINPUT_KEYSTROKE
		pKeystroke // Pointer to an XINPUT_KEYSTROKE structure that receives an input event.
);
