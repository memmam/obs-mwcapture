...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
	...
	(THIS_ UINT32 Index, __out XAUDIO2_DEVICE_DETAILS * pDeviceDetails)
		PURE;
...
#define Declare_IXAudio2Voice_Methods()                                       \
    ...
    */                              \
	...
	(THIS_ __in_opt IXAudio2Voice * pDestinationVoice,                    \
	 UINT32 SourceChannels, UINT32 DestinationChannels,                   \
	 __out_ecount(SourceChannels *                                        \
		      DestinationChannels) float *pLevelMatrix) PURE;         \
                                                                              \
...
DECLARE_INTERFACE_(IXAudio2SourceVoice, IXAudio2Voice)
{
	...
	(THIS_ float Ratio, UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW))
		PURE;
...
#define IXAudio2_CreateSourceVoice(This, ppSourceVoice, pSourceFormat, Flags, \
				   ...
				   pEffectChain)                              \
	((This)->lpVtbl->CreateSourceVoice(                                   \
		This, ppSourceVoice, pSourceFormat, Flags, MaxFrequencyRatio, \
...
#define IXAudio2_CreateMasteringVoice(This, ppMasteringVoice, InputChannels,   \
				      ...
				      pEffectChain)                            \
	((This)->lpVtbl->CreateMasteringVoice(                                 \
		This, ppMasteringVoice, InputChannels, InputSampleRate, Flags, \
		DeviceIndex, pEffectChain))
...
#define IXAudio2_SetDebugConfiguration(This, pDebugConfiguration, pReserved) \
	((This)->lpVtbl->SetDebugConfiguration(This, pDebugConfiguration,    \
					       pReserved))
...
#define IXAudio2Voice_SetChannelVolumes(This, Channels, pVolumes,    \
					OperationSet)                \
	((This)->lpVtbl->SetChannelVolumes(This, Channels, pVolumes, \
					   OperationSet))
...
#define IXAudio2Voice_GetOutputMatrix(This, pDestinationVoice, SourceChannels, \
				      DestinationChannels, pLevelMatrix)       \
	((This)->lpVtbl->GetOutputMatrix(This, pDestinationVoice,              \
					 SourceChannels, DestinationChannels,  \
					 pLevelMatrix))
...
STDAPI XAudio2Create(__deref_out IXAudio2 **ppXAudio2,
	...
	XAUDIO2_PROCESSOR XAudio2Processor X2DEFAULT(XAUDIO2_DEFAULT_PROCESSOR))
{
	...
	HRESULT hr = CoCreateInstance((Flags & XAUDIO2_DEBUG_ENGINE)
					      ? __uuidof(XAudio2_Debug)
					      : __uuidof(XAudio2),
				      NULL, CLSCTX_INPROC_SERVER,
				      __uuidof(IXAudio2), (void **)&pXAudio2);
	if (SUCCEEDED(hr)) {
	...
	HRESULT hr = CoCreateInstance((Flags & XAUDIO2_DEBUG_ENGINE)
				      ...
				      (void **)&pXAudio2);
	if (SUCCEEDED(hr)) {
		hr = pXAudio2->lpVtbl->Initialize(pXAudio2, Flags,
						  XAudio2Processor);
