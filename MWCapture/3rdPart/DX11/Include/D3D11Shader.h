...
DECLARE_INTERFACE_(ID3D11ShaderReflection, IUnknown)
{
	...
	(THIS_ __in REFIID iid, __out LPVOID * ppv) PURE;
	...
	(THIS_ __in LPCSTR Name, __out D3D11_SHADER_INPUT_BIND_DESC * pDesc)
		PURE;
