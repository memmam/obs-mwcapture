	...
	ID2D1Resource : public IUnknown
{
	...
	(__deref_out ID2D1Factory * *factory) CONST PURE;
	...
	ID2D1Bitmap : public ID2D1Resource
{
	...
	(__out FLOAT * dpiX, __out FLOAT * dpiY) CONST PURE;
	...
	(__in_opt CONST D2D1_RECT_U * dstRect, __in CONST void *srcData,
	 UINT32 pitch) PURE;
	...
	ID2D1Brush : public ID2D1Resource
{
	...
	(__in CONST D2D1_MATRIX_3X2_F * transform) PURE;
	...
	ID2D1BitmapBrush : public ID2D1Brush
{
	...
	(__deref_out ID2D1Bitmap * *bitmap) CONST PURE;
	...
	ID2D1Geometry : public ID2D1Resource
{
	...
	(FLOAT strokeWidth, __in_opt ID2D1StrokeStyle * strokeStyle,
	 __in_opt CONST D2D1_MATRIX_3X2_F * worldTransform,
	 FLOAT flatteningTolerance, __out D2D1_RECT_F * bounds) CONST PURE;
	...
	(__in_opt CONST D2D1_MATRIX_3X2_F * worldTransform,
	 FLOAT flatteningTolerance, __out FLOAT * area) CONST PURE;
	...
	(__in_opt CONST D2D1_MATRIX_3X2_F * worldTransform,
	 FLOAT flatteningTolerance, __out FLOAT * length) CONST PURE;
	...
	GetWidenedBounds(FLOAT strokeWidth,
		...
		CONST
	{
		return GetWidenedBounds(strokeWidth, strokeStyle,
	...
	StrokeContainsPoint(D2D1_POINT_2F point, FLOAT strokeWidth,
			    __in_opt ID2D1StrokeStyle * strokeStyle,
			    CONST D2D1_MATRIX_3X2_F & worldTransform,
			    FLOAT flatteningTolerance, __out BOOL * contains)
		CONST
	{
		return StrokeContainsPoint(point, strokeWidth, strokeStyle,
					   &worldTransform, flatteningTolerance,
					   contains);
	}
	...
	{
		return CompareWithGeometry(inputGeometry,
	...
	HRESULT
	CompareWithGeometry(__in ID2D1Geometry * inputGeometry,
			    __in_opt CONST D2D1_MATRIX_3X2_F *
				    inputGeometryTransform,
			    __out D2D1_GEOMETRY_RELATION * relation) CONST
	{
		return CompareWithGeometry(inputGeometry,
	...
	{
		return Tessellate(&worldTransform, flatteningTolerance,
				  tessellationSink);
	}
	...
	Tessellate(__in_opt CONST D2D1_MATRIX_3X2_F * worldTransform,
		   __in ID2D1TessellationSink * tessellationSink) CONST
	{
		return Tessellate(worldTransform,
				  D2D1_DEFAULT_FLATTENING_TOLERANCE,
				  tessellationSink);
	}
	...
	Outline(CONST D2D1_MATRIX_3X2_F & worldTransform,
		...
		__in ID2D1SimplifiedGeometrySink * geometrySink) CONST
	{
		return Outline(&worldTransform, flatteningTolerance,
			       geometrySink);
	}
	...
	{
		return ComputeArea(worldTransform,
				   D2D1_DEFAULT_FLATTENING_TOLERANCE, area);
	}
	...
	{
		return ComputeLength(worldTransform,
				     D2D1_DEFAULT_FLATTENING_TOLERANCE, length);
	}
	...
	ID2D1GeometrySink : public ID2D1SimplifiedGeometrySink
{
	...
	(__in CONST D2D1_BEZIER_SEGMENT * bezier) PURE;
	...
	(__in_ecount(beziersCount) CONST D2D1_QUADRATIC_BEZIER_SEGMENT *
		 beziers,
	 UINT beziersCount) PURE;
	...
	"2cd906c2-12e2-11dc-9fed-001143a055f9") ID2D1Mesh : public ID2D1Resource
{
	...
	//
	STDMETHOD(Open)
	(__deref_out ID2D1TessellationSink * *tessellationSink) PURE;
}; // interface ID2D1Mesh
	...
	ID2D1RenderTarget : public ID2D1Resource
{
	...
	(__in_ecount(gradientStopsCount) CONST D2D1_GRADIENT_STOP *
		 gradientStops,
	...
	(D2D1_POINT_2F point0, D2D1_POINT_2F point1, __in ID2D1Brush * brush,
	 ...
	 __in_opt ID2D1StrokeStyle *strokeStyle = NULL) PURE;
	...
	(__out_opt D2D1_TAG *tag1 = NULL, __out_opt D2D1_TAG *tag2 = NULL)
		CONST PURE;
	...
	(__in CONST D2D1_RECT_F * clipRect, D2D1_ANTIALIAS_MODE antialiasMode)
		PURE;

	STDMETHOD_(void, PopAxisAlignedClip)() PURE;

	STDMETHOD_(void, Clear)
	(__in_opt CONST D2D1_COLOR_F *clearColor = NULL) PURE;
	...
	HRESULT
	CreateBitmap(D2D1_SIZE_U size, __in_opt CONST void *srcData,
		     UINT32 pitch,
	...
	CreateBitmapFromWicBitmap(__in IWICBitmapSource * wicBitmapSource,
				  ...
				  __deref_out ID2D1Bitmap * *bitmap)
	{
		return CreateBitmapFromWicBitmap(wicBitmapSource,
	...
	CreateBitmapBrush(__in ID2D1Bitmap * bitmap,
			  ...
			  __deref_out ID2D1BitmapBrush * *bitmapBrush)
	{
		return CreateBitmapBrush(bitmap, &bitmapBrushProperties, NULL,
					 bitmapBrush);
	}
	...
	CreateBitmapBrush(__in ID2D1Bitmap * bitmap,
			  ...
			  __deref_out ID2D1BitmapBrush * *bitmapBrush)
	{
		return CreateBitmapBrush(bitmap, &bitmapBrushProperties,
					 &brushProperties, bitmapBrush);
	}

	HRESULT
	CreateSolidColorBrush(CONST D2D1_COLOR_F & color,
			      __deref_out ID2D1SolidColorBrush *
				      *solidColorBrush)
	{
	...
	HRESULT
	CreateGradientStopCollection(__in_ecount(gradientStopsCount)
						     CONST D2D1_GRADIENT_STOP *
					     gradientStops,
				     UINT gradientStopsCount,
				     __deref_out ID2D1GradientStopCollection *
	...
	void DrawRoundedRectangle(CONST D2D1_ROUNDED_RECT & roundedRect,
				  ...
				  __in_opt ID2D1StrokeStyle *strokeStyle = NULL)
	{
		DrawRoundedRectangle(&roundedRect, brush, strokeWidth,
				     strokeStyle);
	}
	...
	void FillOpacityMask(__in ID2D1Bitmap * opacityMask,
			     __in ID2D1Brush * brush,
			     D2D1_OPACITY_MASK_CONTENT content,
			     CONST D2D1_RECT_F & destinationRectangle,
			     CONST D2D1_RECT_F & sourceRectangle)
	{
		FillOpacityMask(opacityMask, brush, content,
	...
	// clips it.
	//
	void DrawText(__in_ecount(stringLength) CONST WCHAR * string,
	...
	ID2D1Factory : public IUnknown
{
	...
	(__out FLOAT * dpiX, __out FLOAT * dpiY) PURE;
	...
	(D2D1_FILL_MODE fillMode,
	 ...
	 UINT geometriesCount, __deref_out ID2D1GeometryGroup * *geometryGroup)
		PURE;
	...
	(__in_opt CONST D2D1_DRAWING_STATE_DESCRIPTION *
	...
	(__in CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
	 __in CONST D2D1_HWND_RENDER_TARGET_PROPERTIES *
	...
	CreateEllipseGeometry(CONST D2D1_ELLIPSE & ellipse,
			      __deref_out ID2D1EllipseGeometry *
				      *ellipseGeometry)
	{
	...
	HRESULT
	CreateTransformedGeometry(__in ID2D1Geometry * sourceGeometry,
	...
	CreateStrokeStyle(
		...
		__in_ecount(dashesCount) CONST FLOAT * dashes, UINT dashesCount,
		__deref_out ID2D1StrokeStyle * *strokeStyle)
	{
		return CreateStrokeStyle(&strokeStyleProperties, dashes,
	...
	{
		return CreateWicBitmapRenderTarget(
			target, &renderTargetProperties, renderTarget);
	}
	...
	CreateDxgiSurfaceRenderTarget(
		...
		__deref_out ID2D1RenderTarget * *renderTarget)
	{
		return CreateDxgiSurfaceRenderTarget(
			dxgiSurface, &renderTargetProperties, renderTarget);
	}
}; // interface ID2D1Factory
...
#define ID2D1Bitmap_CopyFromRenderTarget(This, destPoint, renderTarget,      \
					 srcRect)                            \
	((This)->lpVtbl->CopyFromRenderTarget(This, destPoint, renderTarget, \
					      srcRect))
...
#define ID2D1BitmapBrush_QueryInterface(This, riid, ppv)                       \
	((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *)This, riid, \
						       ppv))
...
typedef struct ID2D1LinearGradientBrushVtbl {
	...
	(ID2D1LinearGradientBrush *This) PURE;
...
#define ID2D1LinearGradientBrush_GetGradientStopCollection( \
	...
	((This)->lpVtbl->GetGradientStopCollection(This,    \
						   gradientStopCollection))
...
typedef struct ID2D1GeometryVtbl {
	...
	(ID2D1Geometry *This, FLOAT strokeWidth,
	 __in_opt ID2D1StrokeStyle *strokeStyle,
	 __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform,
	 FLOAT flatteningTolerance, __out D2D1_RECT_F *bounds) PURE;

	STDMETHOD(StrokeContainsPoint)
	(ID2D1Geometry *This, D2D1_POINT_2F point, FLOAT strokeWidth,
	 __in_opt ID2D1StrokeStyle *strokeStyle,
	 __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform,
	 FLOAT flatteningTolerance, __out BOOL *contains) PURE;
	...
	(ID2D1Geometry *This, __in ID2D1Geometry *inputGeometry,
	 __in_opt CONST D2D1_MATRIX_3X2_F *inputGeometryTransform,
	 FLOAT flatteningTolerance,
	 __out D2D1_GEOMETRY_RELATION *relation) PURE;
...
#define ID2D1Geometry_StrokeContainsPoint(This, point, strokeWidth,       \
					  ...
					  flatteningTolerance, contains)  \
	((This)->lpVtbl->StrokeContainsPoint(This, point, strokeWidth,    \
					     strokeStyle, worldTransform, \
					     flatteningTolerance, contains))
...
#define ID2D1RectangleGeometry_GetWidenedBounds(This, strokeWidth,           \
	...
	((This)->lpVtbl->Base.GetWidenedBounds(                              \
		(ID2D1Geometry *)This, strokeWidth, strokeStyle,             \
...
#define ID2D1RectangleGeometry_StrokeContainsPoint(                     \
	...
	((This)->lpVtbl->Base.StrokeContainsPoint(                      \
		(ID2D1Geometry *)This, point, strokeWidth, strokeStyle, \
...
#define ID2D1RectangleGeometry_FillContainsPoint(                   \
	...
	((This)->lpVtbl->Base.FillContainsPoint(                    \
		(ID2D1Geometry *)This, point, worldTransform,       \
		flatteningTolerance, contains))

#define ID2D1RectangleGeometry_CompareWithGeometry(This, inputGeometry,       \
						   inputGeometryTransform,    \
						   flatteningTolerance,       \
						   relation)                  \
...
#define ID2D1RectangleGeometry_Simplify(This, simplificationOption,          \
					worldTransform, flatteningTolerance, \
					geometrySink)                        \
	((This)->lpVtbl->Base.Simplify((ID2D1Geometry *)This,                \
				       simplificationOption, worldTransform, \
				       flatteningTolerance, geometrySink))

#define ID2D1RectangleGeometry_Tessellate(                                    \
	This, worldTransform, flatteningTolerance, tessellationSink)          \
	((This)->lpVtbl->Base.Tessellate((ID2D1Geometry *)This,               \
					 worldTransform, flatteningTolerance, \
					 tessellationSink))
...
#define ID2D1RectangleGeometry_ComputeArea(This, worldTransform,               \
					   flatteningTolerance, area)          \
	((This)->lpVtbl->Base.ComputeArea((ID2D1Geometry *)This,               \
					  worldTransform, flatteningTolerance, \
					  area))

#define ID2D1RectangleGeometry_ComputeLength(This, worldTransform,        \
					     flatteningTolerance, length) \
	((This)->lpVtbl->Base.ComputeLength((ID2D1Geometry *)This,        \
					    worldTransform,               \
					    flatteningTolerance, length))

#define ID2D1RectangleGeometry_ComputePointAtLength(This, length,             \
						    worldTransform,           \
						    flatteningTolerance,      \
						    point, unitTangentVector) \
	((This)->lpVtbl->Base.ComputePointAtLength(                           \
		(ID2D1Geometry *)This, length, worldTransform,                \
		flatteningTolerance, point, unitTangentVector))

#define ID2D1RectangleGeometry_Widen(This, strokeWidth, strokeStyle,      \
				     worldTransform, flatteningTolerance, \
				     geometrySink)                        \
	((This)->lpVtbl->Base.Widen((ID2D1Geometry *)This, strokeWidth,   \
				    strokeStyle, worldTransform,          \
				    flatteningTolerance, geometrySink))
...
#define ID2D1RoundedRectangleGeometry_Simplify(This, simplificationOption,   \
					       worldTransform,               \
					       flatteningTolerance,          \
					       geometrySink)                 \
	((This)->lpVtbl->Base.Simplify((ID2D1Geometry *)This,                \
...
#define ID2D1EllipseGeometry_StrokeContainsPoint(This, point, strokeWidth,    \
						 strokeStyle, worldTransform, \
						 flatteningTolerance,         \
						 contains)                    \
	((This)->lpVtbl->Base.StrokeContainsPoint(                            \
...
#define ID2D1EllipseGeometry_CompareWithGeometry(This, inputGeometry,         \
						 inputGeometryTransform,      \
						 flatteningTolerance,         \
						 relation)                    \
	((This)->lpVtbl->Base.CompareWithGeometry(                            \
...
#define ID2D1EllipseGeometry_ComputePointAtLength(This, length,               \
						  worldTransform,             \
						  flatteningTolerance, point, \
						  unitTangentVector)          \
	((This)->lpVtbl->Base.ComputePointAtLength(                           \
...
typedef struct ID2D1TransformedGeometryVtbl {
	...
	STDMETHOD_(void, GetTransform)
	(ID2D1TransformedGeometry *This,
	 __out D2D1_MATRIX_3X2_F *transform) PURE;
...
#define ID2D1TransformedGeometry_CompareWithGeometry(This, inputGeometry,     \
						     inputGeometryTransform,  \
						     flatteningTolerance,     \
						     relation)                \
	((This)->lpVtbl->Base.CompareWithGeometry(                            \
...
typedef struct ID2D1GeometrySinkVtbl {
	...
	(ID2D1GeometrySink *This, D2D1_POINT_2F point) PURE;
...
#define ID2D1GeometrySink_SetSegmentFlags(This, vertexFlags) \
	((This)->lpVtbl->Base.SetSegmentFlags(               \
		(ID2D1SimplifiedGeometrySink *)This, vertexFlags))
...
#define ID2D1GeometrySink_AddLines(This, points, pointsCount)               \
	((This)->lpVtbl->Base.AddLines((ID2D1SimplifiedGeometrySink *)This, \
				       points, pointsCount))
...
typedef struct ID2D1PathGeometryVtbl {
	...
	(ID2D1PathGeometry *This,
	 __deref_out ID2D1GeometrySink **geometrySink) PURE;

	STDMETHOD(Stream)
	(ID2D1PathGeometry *This, __in ID2D1GeometrySink *geometrySink) PURE;

	STDMETHOD(GetSegmentCount)
	(ID2D1PathGeometry *This, __out UINT32 *count) PURE;
...
typedef struct ID2D1RenderTargetVtbl {
	...
	STDMETHOD(CreateBitmap)
	(ID2D1RenderTarget *This, D2D1_SIZE_U size,
	 __in_opt CONST void *srcData, UINT32 pitch,
	 __in CONST D2D1_BITMAP_PROPERTIES *bitmapProperties,
	 __deref_out ID2D1Bitmap **bitmap) PURE;
	...
	STDMETHOD_(void, FillMesh)
	(ID2D1RenderTarget *This, __in ID2D1Mesh *mesh,
	 __in ID2D1Brush *brush) PURE;
...
#define ID2D1RenderTarget_CreateBitmap(This, size, srcData, pitch, \
				       bitmapProperties, bitmap)   \
	((This)->lpVtbl->CreateBitmap(This, size, srcData, pitch,  \
				      bitmapProperties, bitmap))
...
#define ID2D1RenderTarget_CreateSharedBitmap(This, riid, data,         \
					     bitmapProperties, bitmap) \
	((This)->lpVtbl->CreateSharedBitmap(This, riid, data,          \
					    bitmapProperties, bitmap))
...
#define ID2D1RenderTarget_CreateCompatibleRenderTarget(This, desiredSize,      \
						       desiredPixelSize,       \
						       desiredFormat, options, \
						       bitmapRenderTarget)     \
...
#define ID2D1RenderTarget_DrawRectangle(This, rect, brush, strokeWidth, \
					strokeStyle)                    \
	((This)->lpVtbl->DrawRectangle(This, rect, brush, strokeWidth,  \
				       strokeStyle))
...
#define ID2D1RenderTarget_DrawRoundedRectangle(This, roundedRect, brush, \
	...
	((This)->lpVtbl->DrawRoundedRectangle(This, roundedRect, brush,  \
					      strokeWidth, strokeStyle))
...
#define ID2D1RenderTarget_DrawEllipse(This, ellipse, brush, strokeWidth, \
				      strokeStyle)                       \
	((This)->lpVtbl->DrawEllipse(This, ellipse, brush, strokeWidth,  \
				     strokeStyle))
...
#define ID2D1RenderTarget_FillOpacityMask(This, opacityMask, brush, content, \
...
#define ID2D1BitmapRenderTarget_CreateBitmap(This, size, srcData, pitch,     \
					     bitmapProperties, bitmap)       \
	((This)->lpVtbl->Base.CreateBitmap((ID2D1RenderTarget *)This, size,  \
					   srcData, pitch, bitmapProperties, \
					   bitmap))
...
#define ID2D1BitmapRenderTarget_CreateBitmapFromWicBitmap(                    \
	...
	((This)->lpVtbl->Base.CreateBitmapFromWicBitmap(                      \
		(ID2D1RenderTarget *)This, wicBitmapSource, bitmapProperties, \
		bitmap))

#define ID2D1BitmapRenderTarget_CreateSharedBitmap(This, riid, data,           \
						   bitmapProperties, bitmap)   \
	((This)->lpVtbl->Base.CreateSharedBitmap((ID2D1RenderTarget *)This,    \
						 riid, data, bitmapProperties, \
						 bitmap))

#define ID2D1BitmapRenderTarget_CreateBitmapBrush(                             \
	This, bitmap, bitmapBrushProperties, brushProperties, bitmapBrush)     \
	((This)->lpVtbl->Base.CreateBitmapBrush((ID2D1RenderTarget *)This,     \
...
#define ID2D1BitmapRenderTarget_CreateSolidColorBrush(                         \
	...
	((This)->lpVtbl->Base.CreateSolidColorBrush((ID2D1RenderTarget *)This, \
						    color, brushProperties,    \
						    solidColorBrush))
...
#define ID2D1BitmapRenderTarget_CreateCompatibleRenderTarget(             \
	...
	((This)->lpVtbl->Base.CreateCompatibleRenderTarget(               \
		(ID2D1RenderTarget *)This, desiredSize, desiredPixelSize, \
		desiredFormat, options, bitmapRenderTarget))

#define ID2D1BitmapRenderTarget_CreateLayer(This, size, layer)             \
	((This)->lpVtbl->Base.CreateLayer((ID2D1RenderTarget *)This, size, \
					  layer))
...
#define ID2D1BitmapRenderTarget_DrawLine(This, point0, point1, brush,     \
					 strokeWidth, strokeStyle)        \
	((This)->lpVtbl->Base.DrawLine((ID2D1RenderTarget *)This, point0, \
				       point1, brush, strokeWidth,        \
				       strokeStyle))

#define ID2D1BitmapRenderTarget_DrawRectangle(This, rect, brush, strokeWidth, \
					      strokeStyle)                    \
	((This)->lpVtbl->Base.DrawRectangle((ID2D1RenderTarget *)This, rect,  \
					    brush, strokeWidth, strokeStyle))

#define ID2D1BitmapRenderTarget_FillRectangle(This, rect, brush)             \
	((This)->lpVtbl->Base.FillRectangle((ID2D1RenderTarget *)This, rect, \
					    brush))
...
#define ID2D1BitmapRenderTarget_DrawEllipse(This, ellipse, brush, strokeWidth, \
					    strokeStyle)                       \
	((This)->lpVtbl->Base.DrawEllipse((ID2D1RenderTarget *)This, ellipse,  \
					  brush, strokeWidth, strokeStyle))

#define ID2D1BitmapRenderTarget_FillEllipse(This, ellipse, brush)             \
	((This)->lpVtbl->Base.FillEllipse((ID2D1RenderTarget *)This, ellipse, \
					  brush))

#define ID2D1BitmapRenderTarget_DrawGeometry(This, geometry, brush,      \
					     strokeWidth, strokeStyle)   \
	((This)->lpVtbl->Base.DrawGeometry((ID2D1RenderTarget *)This,    \
					   geometry, brush, strokeWidth, \
					   strokeStyle))

#define ID2D1BitmapRenderTarget_FillGeometry(This, geometry, brush,   \
					     opacityBrush)            \
	((This)->lpVtbl->Base.FillGeometry((ID2D1RenderTarget *)This, \
					   geometry, brush, opacityBrush))

#define ID2D1BitmapRenderTarget_FillMesh(This, mesh, brush) \
	((This)->lpVtbl->Base.FillMesh((ID2D1RenderTarget *)This, mesh, brush))

#define ID2D1BitmapRenderTarget_FillOpacityMask(This, opacityMask, brush,      \
						content, destinationRectangle, \
						sourceRectangle)               \
...
#define ID2D1BitmapRenderTarget_DrawText(This, string, stringLength,         \
					 textFormat, layoutRect,             \
					 defaultForegroundBrush, options,    \
					 measuringMode)                      \
	((This)->lpVtbl->Base.DrawText(                                      \
		(ID2D1RenderTarget *)This, string, stringLength, textFormat, \
...
#define ID2D1BitmapRenderTarget_DrawTextLayout(                         \
	...
	((This)->lpVtbl->Base.DrawTextLayout((ID2D1RenderTarget *)This, \
					     origin, textLayout,        \
					     defaultForegroundBrush, options))
...
#define ID2D1BitmapRenderTarget_SetTransform(This, transform)         \
	((This)->lpVtbl->Base.SetTransform((ID2D1RenderTarget *)This, \
					   transform))

#define ID2D1BitmapRenderTarget_GetTransform(This, transform)         \
	((This)->lpVtbl->Base.GetTransform((ID2D1RenderTarget *)This, \
					   transform))
...
#define ID2D1BitmapRenderTarget_SetTextRenderingParams(This,                \
						       textRenderingParams) \
	((This)->lpVtbl->Base.SetTextRenderingParams(                       \
		(ID2D1RenderTarget *)This, textRenderingParams))

#define ID2D1BitmapRenderTarget_GetTextRenderingParams(This,                \
						       textRenderingParams) \
	((This)->lpVtbl->Base.GetTextRenderingParams(                       \
		(ID2D1RenderTarget *)This, textRenderingParams))
...
#define ID2D1BitmapRenderTarget_PushLayer(This, layerParameters, layer) \
	((This)->lpVtbl->Base.PushLayer((ID2D1RenderTarget *)This,      \
...
#define ID2D1HwndRenderTarget_FillOpacityMask(This, opacityMask, brush,      \
					      content, destinationRectangle, \
					      sourceRectangle)               \
	((This)->lpVtbl->Base.FillOpacityMask(                               \
		(ID2D1RenderTarget *)This, opacityMask, brush, content,      \
...
#define ID2D1DCRenderTarget_FillOpacityMask(This, opacityMask, brush, content, \
					    destinationRectangle,              \
					    sourceRectangle)                   \
	((This)->lpVtbl->Base.FillOpacityMask(                                 \
		(ID2D1RenderTarget *)This, opacityMask, brush, content,        \
...
typedef struct ID2D1FactoryVtbl {
	...
	(ID2D1Factory *This, D2D1_FILL_MODE fillMode,
	 ...
	 __deref_out ID2D1GeometryGroup **geometryGroup) PURE;
...
#define ID2D1Factory_CreateRectangleGeometry(This, rectangle,     \
					     rectangleGeometry)   \
	((This)->lpVtbl->CreateRectangleGeometry(This, rectangle, \
						 rectangleGeometry))

#define ID2D1Factory_CreateRoundedRectangleGeometry(This, roundedRectangle,   \
						    roundedRectangleGeometry) \
	((This)->lpVtbl->CreateRoundedRectangleGeometry(                      \
...
#define ID2D1Factory_CreateTransformedGeometry(This, sourceGeometry,           \
	...
	((This)->lpVtbl->CreateTransformedGeometry(                            \
...
#define ID2D1Factory_CreateStrokeStyle(This, strokeStyleProperties, dashes, \
				       dashesCount, strokeStyle)            \
	((This)->lpVtbl->CreateStrokeStyle(This, strokeStyleProperties,     \
