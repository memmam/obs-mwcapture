...
#define IDXGIAdapter_CheckInterfaceSupport(This, InterfaceName, pUMDVersion) \
	((This)->lpVtbl->CheckInterfaceSupport(This, InterfaceName,          \
					       pUMDVersion))
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE GetDisplayModeList(
		...
		/* [annotation][out] */
		__out_ecount_part_opt(*pNumModes, *pNumModes) DXGI_MODE_DESC *
			pDesc) = 0;
...
#define IDXGIOutput_GetDisplayModeList(This, EnumFormat, Flags, pNumModes, \
				       pDesc)                              \
	((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags,       \
					    pNumModes, pDesc))
...
#define IDXGISwapChain_ResizeBuffers(This, BufferCount, Width, Height,   \
	...
	((This)->lpVtbl->ResizeBuffers(This, BufferCount, Width, Height, \
				       NewFormat, SwapChainFlags))
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE MakeWindowAssociation(
		HWND WindowHandle, UINT Flags) = 0;
