...
#define ID3D10Device1_DrawIndexedInstanced(This, IndexCountPerInstance,       \
...
#define ID3D10Device1_CopySubresourceRegion(This, pDstResource,               \
...
#define ID3D10Device1_CreateShaderResourceView1(This, pResource, pDesc,    \
						ppSRView)                  \
	((This)->lpVtbl->CreateShaderResourceView1(This, pResource, pDesc, \
						   ppSRView))
