...
DECLARE_INTERFACE(ID3DXAllocateHierarchy)
{
	...
	(THIS_ LPCSTR Name, LPD3DXFRAME * ppNewFrame) PURE;
...
DECLARE_INTERFACE(ID3DXSaveUserData)
{
	...
	(CONST D3DXMESHCONTAINER * pMeshContainer,
	 LPD3DXFILESAVEOBJECT pXofSave, LPD3DXFILESAVEDATA pXofMeshData) PURE;
	...
	STDMETHOD(AddTopLevelDataObjectsPre)
	(LPD3DXFILESAVEOBJECT pXofSave) PURE;
	STDMETHOD(AddTopLevelDataObjectsPost)
	(LPD3DXFILESAVEOBJECT pXofSave) PURE;
...
DECLARE_INTERFACE_(ID3DXAnimationSet, IUnknown)
{
	...
	(THIS_ UINT Index, LPCSTR * ppName) PURE;
	STDMETHOD(GetAnimationIndexByName)
	(THIS_ LPCSTR pName, UINT * pIndex) PURE;
...
DECLARE_INTERFACE_(ID3DXKeyframedAnimationSet, ID3DXAnimationSet)
{
	...
	(THIS_ UINT Animation, UINT Key, LPD3DXKEY_QUATERNION pRotationKey)
		PURE;
	...
	(THIS_ UINT Animation, UINT Key, LPD3DXKEY_VECTOR3 pTranslationKey)
		PURE;
	...
	STDMETHOD(UnregisterTranslationKey)
	(THIS_ UINT Animation, UINT Key) PURE;
...
DECLARE_INTERFACE_(ID3DXCompressedAnimationSet, ID3DXAnimationSet)
{
	...
	// Scale keys
	STDMETHOD(GetCompressedData)
	(THIS_ LPD3DXBUFFER * ppCompressedData) PURE;
...
typedef enum _D3DXPRIORITY_TYPE {
	D3DXPRIORITY_LOW =
		0, // This track should be blended with all low priority tracks before mixed with the high priority result
	D3DXPRIORITY_HIGH =
		1, // This track should be blended with all high priority tracks before mixed with the low priority result
...
DECLARE_INTERFACE_(ID3DXAnimationController, IUnknown)
{
	...
	STDMETHOD(UnregisterAnimationSet)
	(THIS_ LPD3DXANIMATIONSET pAnimSet) PURE;
