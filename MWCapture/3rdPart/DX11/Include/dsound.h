...
extern HRESULT WINAPI DirectSoundCaptureCreate8(
	...
	__deref_out LPDIRECTSOUNDCAPTURE8 *ppDSC8, __null LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundFullDuplexCreate(
	...
	__in LPCDSBUFFERDESC pcDSBufferDesc, HWND hWnd, DWORD dwLevel,
...
DECLARE_INTERFACE_(IReferenceClock, IUnknown)
{
	...
	(THIS_ REFERENCE_TIME rtBaseTime, REFERENCE_TIME rtStreamTime,
...
DECLARE_INTERFACE_(IDirectSound8, IDirectSound)
{
	...
	STDMETHOD(CreateSoundBuffer)
	(THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc,
	 __out LPDIRECTSOUNDBUFFER * ppDSBuffer, __null LPUNKNOWN pUnkOuter)
		PURE;
	STDMETHOD(GetCaps)(THIS_ __out LPDSCAPS pDSCaps) PURE;
	STDMETHOD(DuplicateSoundBuffer)
	(THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown)
{
	...
	(THIS_ __in LPDIRECTSOUND pDirectSound,
	 __in LPCDSBUFFERDESC pcDSBufferDesc) PURE;
	STDMETHOD(Lock)
	...
	STDMETHOD(Unlock)
	(THIS_ __in_bcount(dwAudioBytes1) LPVOID pvAudioPtr1,
	 DWORD dwAudioBytes1, __in_bcount_opt(dwAudioBytes2) LPVOID pvAudioPtr2,
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer)
{
	...
	(THIS_ __in REFGUID rguidObject, DWORD dwIndex,
	 __in REFGUID rguidInterface, __deref_out LPVOID * ppObject) PURE;
};
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown)
{
	...
	STDMETHOD(GetDistanceFactor)
	(THIS_ __out D3DVALUE * pflDistanceFactor) PURE;
	STDMETHOD(GetDopplerFactor)
	(THIS_ __out D3DVALUE * pflDopplerFactor) PURE;
	STDMETHOD(GetOrientation)
	(THIS_ __out D3DVECTOR * pvOrientFront, __out D3DVECTOR * pvOrientTop)
		PURE;
	STDMETHOD(GetPosition)(THIS_ __out D3DVECTOR * pvPosition) PURE;
	STDMETHOD(GetRolloffFactor)
	(THIS_ __out D3DVALUE * pflRolloffFactor) PURE;
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown)
{
	...
	(THIS_ __out LPDWORD pdwInsideConeAngle,
	 __out LPDWORD pdwOutsideConeAngle) PURE;
	STDMETHOD(GetConeOrientation)
	(THIS_ __out D3DVECTOR * pvOrientation) PURE;
	STDMETHOD(GetConeOutsideVolume)
	(THIS_ __out LPLONG plConeOutsideVolume) PURE;
	...
	(THIS_ DWORD dwInsideConeAngle, DWORD dwOutsideConeAngle, DWORD dwApply)
		PURE;
	STDMETHOD(SetConeOrientation)
	(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z, DWORD dwApply) PURE;
	STDMETHOD(SetConeOutsideVolume)
	(THIS_ LONG lConeOutsideVolume, DWORD dwApply) PURE;
	STDMETHOD(SetMaxDistance)
	(THIS_ D3DVALUE flMaxDistance, DWORD dwApply) PURE;
	STDMETHOD(SetMinDistance)
	(THIS_ D3DVALUE flMinDistance, DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8, IDirectSoundCaptureBuffer)
{
	...
	(DWORD dwEffectsCount, __out_ecount(dwEffectsCount) LPDWORD pdwFXStatus)
		PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown)
{
	...
	(THIS_ DWORD dwPositionNotifies,
	 __in_ecount(dwPositionNotifies)
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown)
{
	...
	(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
	 __in_bcount(ulInstanceLength) LPVOID pInstanceData,
	...
	(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
	 __in_bcount(ulInstanceLength) LPVOID pInstanceData,
	 ULONG ulInstanceLength, __in_bcount(ulDataLength) LPVOID pPropertyData,
	 ULONG ulDataLength) PURE;
	STDMETHOD(QuerySupport)
	(THIS_ __in REFGUID rguidPropSet, ULONG ulId,
	 __out PULONG pulTypeSupport) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXFlanger, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ __in LPCDSFXFlanger pcDsFxFlanger) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ __out LPDSFXFlanger pDsFxFlanger) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXParamEq, IUnknown)
{
	...
	STDMETHOD(SetAllParameters)
	(THIS_ __in LPCDSFXParamEq pcDsFxParamEq) PURE;
	STDMETHOD(GetAllParameters)
	(THIS_ __out LPDSFXParamEq pDsFxParamEq) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown)
{
	...
	(THIS_ __in LPCGUID pCaptureGuid, __in LPCGUID pRenderGuid,
	 __in LPCDSCBUFFERDESC lpDscBufferDesc,
	 __in LPCDSBUFFERDESC lpDsBufferDesc, HWND hWnd, DWORD dwLevel,
...
#define I3DL2_ENVIRONMENT_PRESET_DEFAULT                                     \
	-1000, -100, 0.0f, 1.49f, 0.83f, -2602, 0.007f, 200, 0.011f, 100.0f, \
		100.0f, 5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_ROOM                                       \
	-1000, -454, 0.0f, 0.40f, 0.83f, -1646, 0.002f, 53, 0.003f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_BATHROOM                                     \
	-1000, -1200, 0.0f, 1.49f, 0.54f, -370, 0.007f, 1030, 0.011f, 100.0f, \
		60.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_LIVINGROOM                             \
	-1000, -6000, 0.0f, 0.50f, 0.10f, -1376, 0.003f, -1104, 0.004f, \
		100.0f, 100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_STONEROOM                                 \
	-1000, -300, 0.0f, 2.31f, 0.64f, -711, 0.012f, 83, 0.017f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_AUDITORIUM                                  \
	-1000, -476, 0.0f, 4.32f, 0.59f, -789, 0.020f, -289, 0.030f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_CONCERTHALL                                \
	-1000, -500, 0.0f, 3.92f, 0.70f, -1230, 0.020f, -2, 0.029f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_CAVE                                     \
	-1000, 0, 0.0f, 2.91f, 1.30f, -602, 0.015f, -302, 0.022f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_ARENA                                      \
	-1000, -698, 0.0f, 7.24f, 0.33f, -1166, 0.020f, 16, 0.030f, 100.0f, \
		100.0f, 5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_CARPETEDHALLWAY                        \
	-1000, -4000, 0.0f, 0.30f, 0.10f, -1831, 0.002f, -1630, 0.030f, \
		100.0f, 100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_HALLWAY                                     \
	-1000, -300, 0.0f, 1.49f, 0.59f, -1219, 0.007f, 441, 0.011f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_STONECORRIDOR                               \
	-1000, -237, 0.0f, 2.70f, 0.79f, -1214, 0.013f, 395, 0.020f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_ALLEY                                      \
	-1000, -270, 0.0f, 1.49f, 0.86f, -1204, 0.007f, -4, 0.011f, 100.0f, \
		100.0f, 5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_PARKINGLOT                                 \
	-1000, 0, 0.0f, 1.65f, 1.50f, -1363, 0.008f, -1153, 0.012f, 100.0f, \
		100.0f, 5000.0f
#define I3DL2_ENVIRONMENT_PRESET_SEWERPIPE                                 \
	-1000, -1000, 0.0f, 2.81f, 0.14f, 429, 0.014f, 648, 0.021f, 80.0f, \
		60.0f, 5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_SMALLROOM                                  \
	-1000, -600, 0.0f, 1.10f, 0.83f, -400, 0.005f, 500, 0.010f, 100.0f, \
		100.0f, 5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_PLATE                                        \
	-1000, -200, 0.0f, 1.30f, 0.90f, 0, 0.002f, 0, 0.010f, 100.0f, 75.0f, \
		5000.0f
