...
typedef struct ID3D11SwitchToRefVtbl {
	...
	(ID3D11SwitchToRef *This, BOOL UseRef);
...
typedef enum D3D11_MESSAGE_ID {
	...
	D3D11_MESSAGE_ID_DESTROY_PREDICATE =
		(D3D11_MESSAGE_ID_LIVE_PREDICATE + 1),
...
public:
	...
	GetNumStoredMessagesAllowedByRetrievalFilter(void) = 0;

	virtual UINT64 STDMETHODCALLTYPE
	GetNumMessagesDiscardedByMessageCountLimit(void) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
		/* [annotation] */
		__out_bcount_opt(*pFilterByteLength) D3D11_INFO_QUEUE_FILTER *
			pFilter,
		/* [annotation] */
...
#define ID3D11InfoQueue_GetMessage(This, MessageIndex, pMessage,  \
				   pMessageByteLength)            \
	((This)->lpVtbl->GetMessage(This, MessageIndex, pMessage, \
				    pMessageByteLength))
