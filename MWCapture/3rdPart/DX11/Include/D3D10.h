...
struct CD3D10_TEXTURE1D_DESC : public D3D10_TEXTURE1D_DESC {
	...
	explicit CD3D10_TEXTURE1D_DESC(
		DXGI_FORMAT format, UINT width, UINT arraySize = 1,
		UINT mipLevels = 0, UINT bindFlags = D3D10_BIND_SHADER_RESOURCE,
		D3D10_USAGE usage = D3D10_USAGE_DEFAULT,
		UINT cpuaccessFlags = 0, UINT miscFlags = 0)
	{
		Width = width;
...
#define ID3D10Texture2D_Map(This, Subresource, MapType, MapFlags,  \
			    pMappedTex2D)                          \
	((This)->lpVtbl->Map(This, Subresource, MapType, MapFlags, \
			     pMappedTex2D))
...
public:
	...
	virtual void STDMETHODCALLTYPE PSSetShaderResources(
		...
		__in_range(0, D3D10_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - 1)
			UINT StartSlot,
		/* [annotation] */
		__in_range(0, D3D10_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT -
				      StartSlot) UINT NumViews,
		/* [annotation] */
		__in_ecount(NumViews) ID3D10ShaderResourceView *const
	...
	virtual void STDMETHODCALLTYPE OMGetRenderTargets(
		...
		__in_range(0, D3D10_SIMULTANEOUS_RENDER_TARGET_COUNT)
			UINT NumViews,
		/* [annotation] */
		__out_ecount_opt(NumViews) ID3D10RenderTargetView *
			*ppRenderTargetViews,
		/* [annotation] */
	...
	virtual void STDMETHODCALLTYPE RSGetViewports(
		...
		__inout /*_range(0, D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE )*/
			...
			NumViewports,
		/* [annotation] */
		__out_ecount_opt(*NumViewports) D3D10_VIEWPORT *
			pViewports) = 0;
...
#define ID3D10Device_PSSetSamplers(This, StartSlot, NumSamplers, ppSamplers) \
	((This)->lpVtbl->PSSetSamplers(This, StartSlot, NumSamplers,         \
				       ppSamplers))
...
#define ID3D10Device_DrawInstanced(This, VertexCountPerInstance,           \
				   ...
				   StartInstanceLocation)                  \
	((This)->lpVtbl->DrawInstanced(This, VertexCountPerInstance,       \
				       InstanceCount, StartVertexLocation, \
				       StartInstanceLocation))
...
#define ID3D10Device_VSSetSamplers(This, StartSlot, NumSamplers, ppSamplers) \
	((This)->lpVtbl->VSSetSamplers(This, StartSlot, NumSamplers,         \
				       ppSamplers))
...
#define ID3D10Device_CopySubresourceRegion(This, pDstResource, DstSubresource, \
	...
	((This)->lpVtbl->CopySubresourceRegion(                                \
		This, pDstResource, DstSubresource, DstX, DstY, DstZ,          \
...
#define ID3D10Device_ClearRenderTargetView(This, pRenderTargetView, ColorRGBA) \
	((This)->lpVtbl->ClearRenderTargetView(This, pRenderTargetView,        \
					       ColorRGBA))

#define ID3D10Device_ClearDepthStencilView(This, pDepthStencilView,     \
					   ClearFlags, Depth, Stencil)  \
	((This)->lpVtbl->ClearDepthStencilView(This, pDepthStencilView, \
					       ClearFlags, Depth, Stencil))
...
#define ID3D10Device_ResolveSubresource(This, pDstResource, DstSubresource,   \
	...
	((This)->lpVtbl->ResolveSubresource(This, pDstResource,               \
					    DstSubresource, pSrcResource,     \
...
#define ID3D10Device_PSGetSamplers(This, StartSlot, NumSamplers, ppSamplers) \
	((This)->lpVtbl->PSGetSamplers(This, StartSlot, NumSamplers,         \
				       ppSamplers))
...
#define ID3D10Device_VSGetSamplers(This, StartSlot, NumSamplers, ppSamplers) \
	((This)->lpVtbl->VSGetSamplers(This, StartSlot, NumSamplers,         \
				       ppSamplers))
...
#define ID3D10Device_GSGetSamplers(This, StartSlot, NumSamplers, ppSamplers) \
	((This)->lpVtbl->GSGetSamplers(This, StartSlot, NumSamplers,         \
				       ppSamplers))

#define ID3D10Device_OMGetRenderTargets(This, NumViews, ppRenderTargetViews, \
					ppDepthStencilView)                  \
	((This)->lpVtbl->OMGetRenderTargets(                                 \
...
#define ID3D10Device_CreateInputLayout(This, pInputElementDescs, NumElements, \
	...
	((This)->lpVtbl->CreateInputLayout(This, pInputElementDescs,          \
					   NumElements,                       \
					   pShaderBytecodeWithInputSignature, \
					   BytecodeLength, ppInputLayout))
...
#define ID3D10Device_CreateVertexShader(This, pShaderBytecode, BytecodeLength, \
					ppVertexShader)                        \
	((This)->lpVtbl->CreateVertexShader(This, pShaderBytecode,             \
...
#define ID3D10Device_CreateGeometryShader(This, pShaderBytecode,            \
	...
	((This)->lpVtbl->CreateGeometryShader(                              \
...
#define ID3D10Device_CheckMultisampleQualityLevels(This, Format, SampleCount, \
						   pNumQualityLevels)         \
	((This)->lpVtbl->CheckMultisampleQualityLevels(                       \
		This, Format, SampleCount, pNumQualityLevels))
...
#define ID3D10Device_CheckCounter(This, pDesc, pType, pActiveCounters, szName, \
	...
	((This)->lpVtbl->CheckCounter(                                         \
		This, pDesc, pType, pActiveCounters, szName, pNameLength,      \
