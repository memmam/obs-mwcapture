...
DECLARE_INTERFACE_(ID3DXBaseEffect, IUnknown)
{
	...
	(THIS_ D3DXHANDLE hPass, D3DXPASS_DESC * pDesc) PURE;
	...
	STDMETHOD_(D3DXHANDLE, GetPass)
	(THIS_ D3DXHANDLE hTechnique, UINT Index) PURE;
	...
	STDMETHOD(GetVector)
	(THIS_ D3DXHANDLE hParameter, D3DXVECTOR4 * pVector) PURE;
	...
	STDMETHOD(GetString)
	(THIS_ D3DXHANDLE hParameter, LPCSTR * ppString) PURE;
...
DECLARE_INTERFACE_(ID3DXEffectStateManager, IUnknown)
{
	...
	(THIS_ UINT RegisterIndex, CONST FLOAT * pConstantData,
	 UINT RegisterCount) PURE;
	STDMETHOD(SetVertexShaderConstantI)
	(THIS_ UINT RegisterIndex, CONST INT * pConstantData,
	 UINT RegisterCount) PURE;
	STDMETHOD(SetVertexShaderConstantB)
	(THIS_ UINT RegisterIndex, CONST BOOL * pConstantData,
	 UINT RegisterCount) PURE;
...
DECLARE_INTERFACE_(ID3DXEffect, ID3DXBaseEffect)
{
	...
	STDMETHOD(SetStateManager)
	(THIS_ LPD3DXEFFECTSTATEMANAGER pManager) PURE;
	STDMETHOD(GetStateManager)
	(THIS_ LPD3DXEFFECTSTATEMANAGER * ppManager) PURE;
	...
	(THIS_ D3DXHANDLE hParameter, LPCVOID pData, UINT ByteOffset,
	 UINT Bytes) PURE;
};
...
DECLARE_INTERFACE_(ID3DXEffectCompiler, ID3DXBaseEffect)
{
	...
	STDMETHOD(GetLiteral)
	(THIS_ D3DXHANDLE hParameter, BOOL * pLiteral) PURE;

	// Compilation
	STDMETHOD(CompileEffect)
	(THIS_ DWORD Flags, LPD3DXBUFFER * ppEffect, LPD3DXBUFFER * ppErrorMsgs)
		PURE;
...
HRESULT WINAPI D3DXCreateEffectFromResourceExA(
	...
	LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool,
	LPD3DXEFFECT *ppEffect, LPD3DXBUFFER *ppCompilationErrors);
...
HRESULT WINAPI D3DXCreateEffectCompilerFromFileA(
	...
	DWORD Flags, LPD3DXEFFECTCOMPILER *ppCompiler,
