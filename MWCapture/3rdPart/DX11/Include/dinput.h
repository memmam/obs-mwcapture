...
DECLARE_INTERFACE_(IDirectInputDeviceW, IUnknown)
{
	...
	(THIS_ LPDIDEVICEOBJECTINSTANCEW, DWORD, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDeviceA, IUnknown)
{
	...
	STDMETHOD(SetCooperativeLevel)(THIS_ HWND, DWORD) PURE;
	STDMETHOD(GetObjectInfo)
	(THIS_ LPDIDEVICEOBJECTINSTANCEA, DWORD, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice2W, IDirectInputDeviceW)
{
	...
	(THIS_ LPDIENUMEFFECTSCALLBACKW, LPVOID, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice2A, IDirectInputDeviceA)
{
	...
	(THIS_ REFGUID, LPCDIEFFECT, LPDIRECTINPUTEFFECT *, LPUNKNOWN) PURE;
	STDMETHOD(EnumEffects)
	(THIS_ LPDIENUMEFFECTSCALLBACKA, LPVOID, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A)
{
	...
	STDMETHOD(WriteEffectToFile)
	(THIS_ LPCSTR, DWORD, LPDIFILEEFFECT, DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput7W, IDirectInput2W)
{
	...
	(THIS_ REFGUID, REFIID, LPVOID *, LPUNKNOWN) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown)
{
	...
	(THIS_ LPCWSTR, LPDIACTIONFORMATW, LPDIENUMDEVICESBYSEMANTICSCBW,
	 LPVOID, DWORD) PURE;
...
#define DIMOUSE_XAXISAB \
	(0x82000200 |   \
	 DIMOFS_X) /* X Axis-absolute: Some mice natively report absolute coordinates  */
#define DIMOUSE_YAXISAB \
	(0x82000200 |   \
	 DIMOFS_Y) /* Y Axis-absolute: Some mice natively report absolute coordinates */
