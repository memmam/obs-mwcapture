...
HRESULT WINAPI D3DX10CompileFromFileA(
	...
	UINT Flags1, UINT Flags2, ID3DX10ThreadPump *pPump,
...
HRESULT WINAPI D3DX10CompileFromResourceA(
	...
	ID3DX10ThreadPump *pPump, ID3D10Blob **ppShader,
...
HRESULT WINAPI D3DX10CreateEffectFromFileA(
	...
	ID3DX10ThreadPump *pPump, ID3D10Effect **ppEffect,
...
HRESULT WINAPI D3DX10CreateAsyncEffectCreateProcessor(
	...
	ID3D10Device *pDevice, ID3D10EffectPool *pPool,
	ID3D10Blob **ppErrorBuffer, ID3DX10DataProcessor **ppProcessor);
...
HRESULT WINAPI D3DX10CreateAsyncMemoryLoader(LPCVOID pData, SIZE_T cbData,
					     ID3DX10DataLoader **ppDataLoader);
HRESULT WINAPI
D3DX10CreateAsyncResourceLoaderW(HMODULE hSrcModule, LPCWSTR pSrcResource,
				 ID3DX10DataLoader **ppDataLoader);
HRESULT WINAPI
D3DX10CreateAsyncResourceLoaderA(HMODULE hSrcModule, LPCSTR pSrcResource,
				 ID3DX10DataLoader **ppDataLoader);
