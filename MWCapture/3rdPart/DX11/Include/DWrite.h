	...
	IDWriteLocalFontFileLoader : public IDWriteFontFileLoader
{
	...
	(__in_bcount(fontFileReferenceKeySize) void const *fontFileReferenceKey,
	 UINT32 fontFileReferenceKeySize,
	 __out_ecount_z(filePathSize) WCHAR *filePath, UINT32 filePathSize)
		PURE;
	...
	IDWriteFontFileStream : public IUnknown
{
	...
	(__deref_out_bcount(fragmentSize) void const **fragmentStart,
	 UINT64 fileOffset, UINT64 fragmentSize, __out void **fragmentContext)
		PURE;
	...
	IDWriteFontFile : public IUnknown
{
	...
	/// </returns>
	STDMETHOD(GetLoader)
	(__out IDWriteFontFileLoader * *fontFileLoader) PURE;
	...
	IDWriteFontFace : public IUnknown
{
	...
	(__in UINT32 openTypeTableTag,
	 ...
	 __out UINT32 *tableSize, __out void **tableContext, __out BOOL *exists)
		PURE;
	...
	(FLOAT emSize, FLOAT pixelsPerDip,
	...
	(FLOAT emSize, FLOAT pixelsPerDip,
	 __in_opt DWRITE_MATRIX const *transform, BOOL useGdiNatural,
	 __in_ecount(glyphCount) UINT16 const *glyphIndices, UINT32 glyphCount,
	 __out_ecount(glyphCount) DWRITE_GLYPH_METRICS *glyphMetrics,
	 BOOL isSideways = FALSE) PURE;
};
	...
	IDWriteLocalizedStrings : public IUnknown
{
	...
	(__in_z WCHAR const *localeName, __out UINT32 *index,
	...
	(UINT32 index, __out UINT32 * length) PURE;
	...
	(UINT32 index, __out_ecount_z(size) WCHAR * localeName, UINT32 size)
		PURE;
	...
	/// </returns>
	STDMETHOD(GetString)
	(UINT32 index, __out_ecount_z(size) WCHAR * stringBuffer, UINT32 size)
		PURE;
};
	...
	IDWriteFontCollection : public IUnknown
{
	...
	(__in_z WCHAR const *familyName, __out UINT32 *index,
	 __out BOOL *exists) PURE;
	...
	IDWriteFont : public IUnknown
{
	...
	STDMETHOD_(void, GetMetrics)
	(__out DWRITE_FONT_METRICS * fontMetrics) PURE;
	...
	IDWriteInlineObject : public IUnknown
{
	...
	(__out DWRITE_INLINE_OBJECT_METRICS * metrics) PURE;
	...
	(__out DWRITE_OVERHANG_METRICS * overhangs) PURE;
	...
	IDWriteTextLayout : public IDWriteTextFormat
{
	...
	(FLOAT fontSize, DWRITE_TEXT_RANGE textRange) PURE;
	...
	(BOOL hasUnderline, DWRITE_TEXT_RANGE textRange) PURE;
	...
	(UINT32 currentPosition,
	 __out_ecount_z(nameSize) WCHAR * fontFamilyName, UINT32 nameSize,
	 __out_opt DWRITE_TEXT_RANGE *textRange = NULL) PURE;
	...
	(__out_ecount_opt(maxClusterCount) DWRITE_CLUSTER_METRICS *
		 clusterMetrics,
	...
	(FLOAT pointX, FLOAT pointY, __out BOOL * isTrailingHit,
	 __out BOOL * isInside, __out DWRITE_HIT_TEST_METRICS * hitTestMetrics)
		PURE;
	...
	(UINT32 textPosition, BOOL isTrailingHit, __out FLOAT * pointX,
	 __out FLOAT * pointY, __out DWRITE_HIT_TEST_METRICS * hitTestMetrics)
		PURE;
	...
	IDWriteBitmapRenderTarget : public IUnknown
{
	...
	(__in_opt DWRITE_MATRIX const *transform) PURE;
	...
	IDWriteGdiInterop : public IUnknown
{
	...
	(IDWriteFont * font, __out LOGFONTW * logFont,
	 __out BOOL * isSystemFont) PURE;
	...
	IDWriteGlyphRunAnalysis : public IUnknown
{
	...
	(IDWriteRenderingParams * renderingParams, __out FLOAT * blendGamma,
	 __out FLOAT * blendEnhancedContrast, __out FLOAT * blendClearTypeLevel)
		PURE;
};
	...
	IDWriteFactory : public IUnknown
{
	...
	(IDWriteFontCollectionLoader * collectionLoader,
	 __in_bcount(collectionKeySize) void const *collectionKey,
	 UINT32 collectionKeySize, __out IDWriteFontCollection **fontCollection)
		PURE;
	...
	(HMONITOR monitor, __out IDWriteRenderingParams * *renderingParams)
		PURE;
	...
	(__in_z WCHAR const *fontFamilyName,
	 ...
	 __in_z WCHAR const *localeName, __out IDWriteTextFormat **textFormat)
		PURE;
	...
	(__out IDWriteTextAnalyzer * *textAnalyzer) PURE;
