...
D2D1FORCEINLINE
D2D1_RECT_F
RectF(FLOAT left = 0.f, FLOAT top = 0.f, FLOAT right = 0.f, FLOAT bottom = 0.f)
{
...
{
	D2D1_ARC_SEGMENT arcSegment = {point, size, rotationAngle,
...
BrushProperties(__in FLOAT opacity = 1.0,
			      ...
			      FLOAT radiusX, FLOAT radiusY)
{
	...
	radialGradientBrushProperties.gradientOriginOffset =
...
LayerParameters(__in CONST D2D1_RECT_F &contentBounds = D2D1::InfiniteRect(),
...
private:
	...
	{
		this->r =
			static_cast<FLOAT>((rgb & sc_redMask) >> sc_redShift) /
			255.f;
		this->g = static_cast<FLOAT>((rgb & sc_greenMask) >>
					     sc_greenShift) /
			  255.f;
		this->b = static_cast<FLOAT>((rgb & sc_blueMask) >>
					     sc_blueShift) /
			  255.f;
		this->a = a;
	}
...
public:
	D2D1FORCEINLINE
	Matrix3x2F(FLOAT _11, FLOAT _12, FLOAT _21, FLOAT _22, FLOAT _31,
		   FLOAT _32)
	{
		this->_11 = _11;
		this->_12 = _12;
	...
	{
		return _11 == 1.f && _12 == 0.f && _21 == 0.f && _22 == 1.f &&
		       _31 == 0.f && _32 == 0.f;
	}
